...
(self["webpackChunkelementor_pro"] =
  ...
  \***************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class MenuTitleKeyboardHandler
          extends elementorModules.frontend.handlers.Base
        {
          ...
          getDefaultElements() {
            ...
            return {
              ...
              $focusableMenuElements: this.findElement(
                selectors.focusableMenuElement,
              ),
          ...
          getActiveTitleElement() {
            ...
            return this.elements.$focusableMenuElements.filter(
              activeTitleFilter,
            );
          }
          onInit() {
              ...
              case "Tab":
                ...
                const $menuItemElements = this.elements.$focusableMenuElements,
                  ...
                  isLastMenuItemElementForward =
                    isForward &&
                    $menuItemElements.last().is(jQuery(event.currentTarget)),
                  isFirstMenuItemElementBackwards =
                    !isForward &&
                    $menuItemElements.first().is(jQuery(event.currentTarget));
                if (
          ...
          isDropdownLayout() {
            ...
            return (
              "dropdown" ===
              this.$element
                .find(selectors.widgetInnerWrapper)
                .attr("data-layout")
            );
          }
          closeMenuDropdown() {
          ...
          handleTitleHomeOrEndKey(event) {
            ...
            const currentTitleIndex =
                this.getTitleIndex(event.currentTarget) || 1,
          ...
          handleContentElementTabEvents(event) {
            const selectors = this.getSettings("selectors"),
              ...
              $focusableContainerElements =
                this.getFocusableElements($currentContainer),
              $lastFocusableElement = $focusableContainerElements.last();
            const isCurrentElementLastFocusableElement = $currentElement.is(
            ...
            const menuItemSelector = selectors.menuItem,
              ...
              isDropdownAndLastMenuItem =
                this.isDropdownLayout() && isLastMenuItem;
          ...
          updateIndexValues(view) {
            ...
            tabTitles.forEach((element) => {
              if (element.querySelector("a")) {
                element
                  .querySelector("a")
                  .setAttribute("data-focus-index", focusTitleCount++);
              }
              if (element.querySelector(tabDropdown)) {
                element
                  .querySelector(tabDropdown)
                  .setAttribute("data-focus-index", focusTitleCount++);
              }
            });
          }
          updateListeners(view) {
            ...
            this.elements.$focusableMenuElements =
              view.find(focusableMenuElement);
