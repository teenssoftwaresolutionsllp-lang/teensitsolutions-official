          ...
          assignProLicenseActivateEvent() {
            window.addEventListener("DOMContentLoaded", () => {
              const activateButton = document.querySelector(
                '.button-primary[href*="elementor-connect"]',
              );
              if (activateButton) {
                activateButton.addEventListener("click", () => {
                  ...
                  const eventsManager =
                    window.elementorCommon?.eventsManager || {};
                  const dispatchEvent =
                    eventsManager.dispatchEvent?.bind(eventsManager);
  ...
  \***************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class CustomIcons extends _customAssetsBase.default {
          getDefaultSettings() {
            return {
              ...
              templates: {
                ...
                header: jQuery(
                  "#elementor-custom-icons-template-header",
                ).html(),
                footer: jQuery(
                  "#elementor-custom-icons-template-footer",
                ).html(),
          ...
          enqueueCSS(url) {
            if (
              !elementorCommon.elements.$document.find(
                'link[href="' + url + '"]',
              ).length
            ) {
          ...
          renderIcons(config) {
            const { $metaboxContainer, $metabox, $submitMetabox } =
              this.elements;
            ...
            $metabox.html("");
            $metaboxContainer.prepend(
              elementorCommon.compileTemplate(header, config),
            );
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class CustomFontsManager extends _customAssetsBase.default {
          ...
          updateRowLabel(event, $table) {
            ...
            if ($editBtn.length > 0) {
              $editBtn
                .not(selectors.toolbar + " " + selectors.editRowBtn)
                .remove();
            }
            if ($closeBtn.length > 0) {
              $closeBtn
                .not(selectors.toolbar + " " + selectors.closeRowBtn)
                .remove();
            }
            ...
            return this.renderTemplate(fontLabelTemplate, {
              weight:
                '<span class="label">Weight:</span>' + previewStyle.weight,
          ...
          onInit() {
            ...
            const markMetaboxIfVariableFont =
              this.markMetaboxIfVariableFont.bind(this);
            jQuery("#add-variable-font").on("click", () => {
              jQuery(document).one(
                "onRepeaterNewRow",
                (event, $repeaterBtn, $repeaterBlock) => {
                  $repeaterBlock
                    .find('input[name$="font_type]"]')
                    .val("variable");
                  markMetaboxIfVariableFont();
                },
              );
              jQuery("#elementor-font-custommetabox")
                .find(".add-repeater-row")
                .trigger("click");
            });
  ...
  \**********************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class DropZoneField extends elementorModules.ViewModule {
          ...
          onInit() {
            super.onInit();
            elementorCommon.elements.$document.trigger("onDropzoneLoaded", [
              this,
            ]);
          }
        }
      ...
      /***/ (module) => {
        ...
        module.exports = {
          ...
          countBlocks($btn) {
            return (
              $btn
                .closest(this.selectors.repeaterField)
                .find(this.selectors.block).length || 0
            );
          },
          add(btn) {
            var self = this,
      ...
      /***/ (module) => {
        ...
        module.exports = {
          ...
          setup() {
            const self = this;
            jQuery(
              self.selectors.uploadBtn + ", " + self.selectors.clearBtn,
            ).each(function () {
  ...
  \*******************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = function () {
          ...
          document
            .querySelector(
              '.e-notice--cta.e-notice--dismissible[data-notice_id="send_app_forms_submissions_notice"] a.e-button--cta',
            )
  ...
  \**********************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = function () {
          ...
          this.stripeTestSecretKey = new ApiValidations(
            "stripe_test_secret_key",
          );
          this.stripeLiveSecretKey = new ApiValidations(
      ...
      /***/ (module) => {
        ...
        module.exports = function () {
          var selectors = {
            ...
            postTypeWrapper:
              "#elementor-new-template__form__post-type__wrapper",
          };
          var elements = {
          ...
          const setPostType = () => {
            ...
            const postType =
              postTypeMap[elements.$templateTypeInput.val()] || "";
