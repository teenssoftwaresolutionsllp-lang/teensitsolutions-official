...
/******/ (() => {
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class DisplayConditionsBehavior extends Marionette.Behavior {
          ...
          mount() {
            const colorScheme =
                elementor?.getPreferences?.("ui_theme") || "auto",
  ...
  \********************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ConditionsRepeaterRow = (_ref) => {
          let { andConditionIndex, orConditionIndex } = _ref;
          const { selectedConditions, conditionsConfig, dispatch } = (0,
            _useConditions.default)(),
            { conditions: availableConditions, flattenedConditionOptions } =
              conditionsConfig,
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            /*#__PURE__*/ React.createElement(
              _conditionSelectControl.default,
              {
                ...
                onChange: (event) =>
                  handleChangeCondition(event, andConditionIndex),
                controlCount: controlCount,
              },
              flattenedConditionOptions.map((_ref2) => {
                let { key, label, isGroup } = _ref2;
                return isGroup
                  ? /*#__PURE__*/ React.createElement(
                      _ui.ListSubheader,
                      {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const Content = (_ref) => {
          ...
          const [showConditions, setShowConditions] =
              _react.default.useState(true),
            [conditionsStore, dispatch] = (0, _react.useReducer)(
              _conditionsReducer.conditionsReducer,
              initialState,
            ),
            [saveButtonDisplay, setSaveButtonDisplay] = (0, _react.useState)(
              false,
            ),
          ...
          const handleEmptyFieldsAndGetFirstInvalidIndex = () => {
            ...
            selectedConditions.forEach((orCondition, orConditionIndex) => {
              ...
              } = handleEmptyFieldsPerConditionSet(
                orCondition,
                orConditionIndex,
              );
              if (
          ...
          const handleEmptyFieldsPerConditionSet = (
            orCondition,
            orConditionIndex,
          ) => {
            ...
            orCondition.forEach((andCondition, andConditionIndex) => {
              ...
              const isCurrentConditionInvalid =
          ...
          const handleInvalidRequiredKeysPerCondition = (_ref2) => {
            ...
            requiredKeys.forEach((controlKey) => {
              const value = andCondition[controlKey],
                { type, variant = null } =
                  conditionsConfig.conditions[conditionKey].controls[
                    controlKey
                  ];
              if (
                value?.length ||
                (0, _utils.shouldEmptyValuePassValidation)(
                  andCondition.condition,
                  andCondition.comparator,
                )
              ) {
                return;
              }
              ...
              dispatch({
                ...
                orConditionIndex,
                errors: {
                  [controlKey]: (0, _utils.getInvalidInputFeedback)(
                    type,
                    variant,
                    value,
                    true,
  ...
  \*************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ControlRenderer = (_ref) => {
          ...
          const { conditionsConfig, selectedConditions, dispatch } = (0,
            _useConditions.default)(),
          ...
          const extractControlPropsFromGlobals = (defaultAltValue) => {
            ...
            if (
              (0, _utils.shouldDisableControl)(
                controlKey,
                controlProps.condition.comparator,
              )
            ) {
          ...
          const getControlValueRelatedProps = (defaultAltValue) => {
            ...
            const defaultValue = (0, _utils.getControlValue)(
              ...
              value = (0, _utils.getControlValue)(
                andCondition[controlKey],
                defaultValue,
              );
  ...
  \**************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const AutocompleteControl = (_ref) => {
          ...
          const [controlValue, setControlValue] = (0, _react.useState)(
              formatValue(value),
            ),
            label = controlValue?.length
              ? ""
              : conditions[condition.condition].label || "";
          (0, _react.useEffect)(() => {
          ...
          return /*#__PURE__*/ React.createElement(_ui.Autocomplete, {
            ...
            onChange: (_event, newValues) =>
              handleChangeOption(formatValue(newValues)),
  ...
  \*******************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const QueryControl = (_ref) => {
          ...
          const { fetchData } = (0, _react.useContext)(
              _conditionsContext.ConditionsContext,
            ),
            [controlValue, setControlValue] = (0, _react.useState)(
              formatValue(value),
            ),
          ...
          return /*#__PURE__*/ _react.default.createElement(_ui.Autocomplete, {
            ...
            isOptionEqualToValue: (option, optionToCompare) =>
              option.id === optionToCompare.id,
            filterOptions: (x) => x,
            ...
            onInputChange: (event, newInputValue) =>
              handleSearchInputChange(event, newInputValue, controlValue),
            renderOption: (optionProps, option) =>
              /*#__PURE__*/ _react.default.createElement(
                _ui.Typography,
                (0, _extends2.default)(
            ...
            return Object.entries(options).map((_ref2) => {
              ...
              return /*#__PURE__*/ React.createElement(
                _ui.MenuItem,
                {
                  ...
                  disabled: isDisabled,
                  className:
                    isDisabled && "hidden" === control?.disabled_type
                      ? "elementor-hidden"
                      : "",
                },
                /*#__PURE__*/ React.createElement(
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const TextFieldControl = (_ref) => {
          ...
          const handleChangeOption = (newValue, controlVariant) => {
            ...
            if (
              "number" === controlVariant &&
              (0, _utils.hasDecimalSeparator)(newValue)
            ) {
          ...
          return /*#__PURE__*/ React.createElement(
            ...
            (0, _extends2.default)({}, numericProps, {
              ...
              variant: "outlined",
              onChange: (event) =>
                handleChangeOption(event.target.value, variant),
              size: "small",
              color: "secondary",
  ...
  \*************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const TimePickerControl = (_ref) => {
          ...
          const handleChangeOption = (newValue) => {
            const dateString = (0, _dayjs.default)(
              newValue,
              dateFormat,
              true,
            ).isValid()
  ...
  \********************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ConditionSelectOption = (_ref) => {
          let { controlCount, sx = {}, ...props } = _ref;
          return /*#__PURE__*/ _react.default.createElement(
            _ui.Typography,
            (0, _extends2.default)(
              {
  ...
  \***************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const Footer = (_ref) => {
          let { onClickSaveButton, isButtonDisabled } = _ref;
          return /*#__PURE__*/ React.createElement(
            _ui.Stack,
            {
              direction: "row",
  ...
  \*********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const OrRowGroup = (_ref) => {
          let { showConditions, setShowConditions } = _ref;
          const { selectedConditions, conditionsConfig, dispatch } = (0,
            _useConditions.default)(),
            { conditions: availableConditions, conditionsByGroup } =
              conditionsConfig,
          ...
          const addOrCondition = () => {
            const conditionKey = (0, _utils.getDefaultActiveCondition)(
                conditionsByGroup,
              ),
              defaultValues = (0, _utils.getConditionInitialState)(
                availableConditions,
                conditionKey,
              ),
              andCondition = {
  ...
  \************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const RowControls = (_ref) => {
          let { orConditionIndex, andConditionIndex } = _ref;
  ...
  \*************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const ConditionsContext = (exports.ConditionsContext =
          React.createContext());
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class Module extends elementorModules.editor.utils.Module {
          ...
          registerContextMenuGroups(groups, currentElement) {
            const clipboardGroup = groups.find(
              (group) => "clipboard" === group.name,
            );
            if (!clipboardGroup) {
              return groups;
            }
            ...
            const pasteStyleIndex = clipboardGroup.actions.findIndex(
              (action) => "pasteStyle" === action.name,
            );
            if (-1 !== pasteStyleIndex) {
              clipboardGroup.actions.splice(pasteStyleIndex + 1, 0, {
                name: "pasteDisplayConditions",
                isEnabled: () =>
                  this.isPasteDisplayConditionsEnabled(currentElement),
                isVisible: () =>
                  this.isPasteDisplayConditionsEnabled(currentElement),
            ...
            clipboardGroup.actions.push({
              ...
              isEnabled: () =>
                this.isClearDisplayConditionsEnabled(currentElement),
              isVisible: () =>
                this.isClearDisplayConditionsEnabled(currentElement),
              // Need both for Core/Pro dependancy.
          ...
          isPasteDisplayConditionsEnabled(selectedElement) {
            const displayConditions =
                this.getSelectedElementDisplayCondition(selectedElement),
              doesClipboardHaveConditions = !!JSON.parse(
                this.getDisplayConditionsFromClipboard(),
              ).length;
            return (
              !displayConditions.length &&
              !elementor.selection.isMultiple() &&
              doesClipboardHaveConditions
            );
          }
          isClearDisplayConditionsEnabled(selectedElement) {
            const displayConditions =
              this.getSelectedElementDisplayCondition(selectedElement);
            return (
              displayConditions.length && !elementor.selection.isMultiple()
            );
          }
          getSelectedElementDisplayCondition(selectedElement) {
            return JSON.parse(
              selectedElement?.model?.getSetting(
          ...
          tryContextMenuActions(containers, action) {
            ...
            try {
              const controlView = container.panel.getControlView(
                  this.getSettings("controls").displayConditions,
                ),
                icon = this.getEditorControlView(
                  this.getSettings("controls").trigger,
                ).$el.find(this.getSettings("selectors").icon);
          ...
          registerControlBehavior = (behaviors, view) => {
            ...
            const conditionsByGroup = this._getGroupedConditionKeys(
              elementor.config.displayConditions || {},
            );
            const flattenedConditionOptions =
              this._getFlattenedConditionOptions(conditionsByGroup);
            behaviors.displayConditions = {
              behaviorClass: _behavior.default,
              getControlValue: () => {
                const controlView = this.getEditorControlView(
                  this.getSettings("controls").displayConditions,
                );
                if (!controlView) {
                  return [];
                }
                return this._getStructuredConditions(
                  JSON.parse(controlView.getControlValue() || "[]"),
                );
              },
              setControlValue: (value) => {
          ...
          highlightIcon = (icon, controlView) => {
            ...
            const conditionValue = controlView.getControlValue() || "[]",
              conditionArray =
                "[]" !== conditionValue
                  ? this._getStructuredConditions(JSON.parse(conditionValue))
                  : [];
          ...
          _getStructuredConditions = (conditions) => {
            return this._shouldConvertConditionsStructure(conditions)
              ? [conditions]
              : conditions;
          };
          ...
          _getGroupedConditionKeys = (conditionsConfig) => {
            return Object.keys(conditionsConfig?.groups || {}).reduce(
              (group, groupName) => {
                const conditions = this._getConditionKeyByGroup(
          ...
          _getFlattenedConditionOptions = (conditionsByGroup) => {
            const { conditions = {}, groups = {} } =
              elementor.config.displayConditions || {};
            return Object.entries(conditionsByGroup).reduce(
              (optionList, _ref) => {
  ...
  \*************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const _changeConditionType = (_ref) => {
          ...
          const newOrCondition = selectedConditions[orConditionIndex].map(
            (andCondition, index) =>
        ...
        const _addAndCondition = (_ref3) => {
          ...
          const existingOrCondition = selectedConditions[orConditionIndex],
            newOrCondition = existingOrCondition.reduce(
              (newAndConditions, condition, index) => {
                ...
                if (
                  index === andConditionIndex ||
                  (existingOrCondition.length === andConditionIndex &&
                    existingOrCondition.length - 1 === index)
                ) {
        ...
        const _removeAndCondition = (_ref4) => {
          let { selectedConditions, orConditionIndex, andConditionIndex } =
            _ref4;
          ...
          return selectedConditions.reduce(
            (newOrConditions, orCondition, index) => {
        ...
        const getControlDefaults = (controlKey, control) => {
          const { type, variant = null, options } = control,
            ...
            formattedDefaultValue =
              shouldCastToArray(type) && !Array.isArray(defaultValue)
                ? [defaultValue]
                : defaultValue,
            error = getInvalidInputFeedback(
              type,
              variant,
              formattedDefaultValue,
            );
        ...
        const getConditionInitialState = (conditions, conditionKey) => {
          ...
          return Object.keys(controls).reduce(
            (defaults, controlKey) => {
              ...
              const { defaultValue, error } = getControlDefaults(
                controlKey,
                controls[controlKey],
              );
