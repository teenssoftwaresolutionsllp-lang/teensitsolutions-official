  ...
  var e = {
      2098: (e, t, r) => {
        ...
        (Object.defineProperty(t, "__esModule", { value: !0 }),
          ...
          (t.default = function addDocumentHandle(e) {
            let {
                element: t,
                id: r,
                title: u = n("Template", "elementor-pro"),
              } = e,
              s =
              ...
              f =
                arguments.length > 3 && void 0 !== arguments[3]
                  ...
                  : null;
            if (a === s) {
              if (!r || !t) throw Error("`id` and `element` are required.");
              if (
            ...
            const p = (function createHandleElement(e, t) {
              let { title: r, onClick: i } = e,
                u =
                  arguments.length > 2 && void 0 !== arguments[2]
                    ? arguments[2]
                    : null;
              const s = ["header", "footer"].includes(u?.dataset.elementorType)
                  ? "%s"
                ...
                l = createElement({
                  ...
                  children: [
                    ...
                    createElement({
                      tag: "div",
                      classNames: [`${a === t ? o : c}__title`],
                      children: [
                        document.createTextNode(
                          a === t
                            ? s.replace("%s", r)
                            : n("Save %s", "elementor-pro").replace("%s", r),
                        ),
                      ],
                    }),
                  ],
              ...
              return (p.addEventListener("click", i), p);
            })(
              {
                title: u,
                onClick: () =>
            ...
            (t.prepend(p),
              a === s && (t.dataset.editableElementorDocument = r));
          }),
          r(6281),
          r(5724));
        ...
        function createElement(e) {
          let { tag: t, classNames: r = [], children: n = [] } = e;
          const o = document.createElement(t);
          return (o.classList.add(...r), n.forEach((e) => o.appendChild(e)), o);
        }
      },
      2470: (e) => {
        e.exports = wp.i18n;
      ...
      169: (e, t, r) => {
        var n = r(4762),
          ...
          w = (e.exports = function (e, t, r) {
            ...
            return (
              a(n, "source") ||
                (n.source = h(b, "string" == typeof t ? t : "")),
              e
            );
          });
              ...
              "undefined" != typeof document
                ? document.domain && n
                  ...
                  : ((t = s("iframe")),
                    ...
                    e.F)
                : NullProtoObjectViaActiveX(n);
            for (var o = a.length; o--;) delete NullProtoObject[f][a[o]];
        ...
        ((c[d] = !0),
          (e.exports =
            ...
            function create(e, t) {
              ...
              return (
                null !== e
                  ? ((EmptyConstructor[f] = o(e)),
                    (r = new EmptyConstructor()),
                    (EmptyConstructor[f] = null),
                    (r[d] = e))
                  : (r = NullProtoObject()),
                void 0 === t ? r : i.f(r, t)
              );
      ...
      1: (e, t, r) => {
        ...
        e.exports = function (e) {
          return (
            i(l, e) || (l[e] = c && i(s, e) ? s[e] : f("Symbol." + e)),
            l[e]
          );
        };
      },
