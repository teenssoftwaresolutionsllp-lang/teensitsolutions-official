        ...
        class baseTabs extends elementorModules.frontend.handlers.Base {
          ...
          handleKeyboardNavigation(event) {
            const tab = event.currentTarget,
              $tabList = jQuery(
                tab.closest(this.getSettings("selectors").tablist),
              ),
          ...
          bindEvents() {
            this.elements.$tabTitles.on({
              keydown: (event) => {
                ...
                if (
                  ["End", "Home", "ArrowUp", "ArrowDown"].includes(event.key)
                ) {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function getEventVideoObject(widgetObject, positionInVideoList) {
          const currentVideoIndex =
              positionInVideoList || widgetObject.currentPlaylistItemIndex,
            currentVideo =
              widgetObject.playlistItemsArray[currentVideoIndex - 1];
          return {
  ...
  \***************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class VideoPlaylistHandler extends _baseTabs.default {
          ...
          onInit() {
            ...
            const storageObject = elementorFrontend.storage.get(
              this.storageKey,
            );
            if (storageObject) {
     ...
     */
          ...
          getCurrentPlayerPlaying() {
            return this.playlistItemsArray[
              this.currentPlayingPlaylistItemIndex - 1
            ].playerInstance;
          }
          ...
          handleVideo(playListItem) {
            ...
            if (playListItem.playerInstance) {
              ...
              playListItem.playerInstance.create().then(() => {
                ...
                playListItem.playerInstance.handlePaused(
                  (positionInVideoList) => {
          ...
          createPlaylistItems() {
            ...
            this.elements.$videos.each((index, tabContent) => {
              ...
              playListItem.videoDuration = $tabContent.attr(
                "data-video-duration",
              );
              playListItem.tabContent = tabContent;
              playListItem.dataTab = index + 1;
              playListItem.dataItemId =
                this.getElementSettings().tabs[index]._id;
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function toggleInnerTabs(event, clickedTab, widgetObject) {
          ...
          if (
            clickedTab.hasClass("e-inner-tab-active") ||
            tabTitles.length < 2
          ) {
            return;
          }
          const tabsContents = activeTabWrapper.querySelectorAll(
            ".e-inner-tab-content",
          );
        ...
        function handleInnerTabs(event, widgetObject) {
          ...
          if (clickedTarget.classList.contains("e-inner-tab-title-text")) {
            event.preventDefault();
            const $clickedTab =
              jQuery(clickedTarget).parent(".e-inner-tab-title");
        ...
        function handleInnerTabsButtonsDisplay(
          ...
          const activeInnerTab = tabsContents.filter((tabsContent) =>
            ...
            innerTabScrollableHeight = activeInnerTab[0].querySelector(
              ".e-inner-tab-text > div",
            ).offsetHeight,
            innerTabsLimitHeight = parseInt(innerTabsHeightLimit.size);
          if (
            innerTabsLimitHeight &&
            innerTabScrollableHeight > innerTabsLimitHeight
          ) {
            activeInnerTab[0].classList.add("show-inner-tab-buttons");
          }
        }
        function onTabContentButtonsClick(event, widgetObject) {
          const $tabsContent = jQuery(event.currentTarget).find(
              ".e-inner-tab-content",
            ),
  ...
  \********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class playerVimeo extends _playerBase.default {
          ...
          handleFullScreenChange(callback) {
            this.playerObject.element.addEventListener(
              "fullscreenchange",
              () => {
                callback(document.fullscreenElement);
