      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class galleryHandler extends elementorModules.frontend.handlers.Base {
          ...
          getDefaultElements() {
            ...
            elements.$images = elements.$items.children(
          ...
          toggleOverlayContentAnimation() {
            ...
            const contentHoverAnimation = this.getElementSettings(
          ...
          toggleImageHoverAnimation() {
            const imageHoverAnimation = this.getElementSettings(
            ...
            this.elements.$titles
              ...
              .on("keyup", (event) => {
                const ENTER_KEY = 13,
                  SPACE_KEY = 32;
                if (
                  ENTER_KEY === event.keyCode ||
                  SPACE_KEY === event.keyCode
                ) {
          ...
          galleriesNavigationListener(event) {
            ...
            const updateLightboxGroup = () =>
              this.setLightboxGalleryIndex(
                clickedElement.data("gallery-index"),
              );
