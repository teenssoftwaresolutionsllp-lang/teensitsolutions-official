      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class TOCHandler extends elementorModules.frontend.handlers.Base {
          ...
          getDefaultElements() {
            ...
            let widgetContainer = this.$element.find(
            ...
            return {
              ...
              $expandButton: this.$element.find(
                settings.selectors.expandButton,
              ),
          ...
          getContainer() {
            ...
            if (elementSettings.container) {
              return jQuery(
                _dompurify.default.sanitize(elementSettings.container),
              );
            }
          ...
          getNestedLevel(level) {
            ...
            while (this.listItemPointer < this.headingsData.length) {
              ...
              if (0 === currentItem.level) {
                ...
                listItemTextClasses +=
                  " " + settings.classes.firstLevelListItem;
              }
          ...
          handleNoHeadingsFound() {
            const noHeadingsText = this.getElementSettings(
              "no_headings_message",
            );
