  ...
  [249],
  {
    ...
    2319: (e, t, n) => {
      ...
      class FloatingBarsHandler extends i.default {
        ...
        isMobileDevice() {
          return ["mobile", "mobile_extra"].includes(
        ...
        cloneHeadlinesToFillContainer() {
          ...
          for (; e < t;)
            (this.cloneScrollerContent(),
              (e = this.elements.headlinesInner.offsetWidth));
        }
        cloneHeadlinesInner() {
        ...
        handleBrowserScrollAnimation() {
          document.addEventListener("scroll", () => {
            ...
            if (elementorFrontend.config.is_rtl) {
              ...
              t.lastElementChild.getBoundingClientRect().left >=
        ...
        handleTickerClick(e) {
          ...
          if (this.elements.headlines.classList.contains(t))
            this.pauseCarousel();
          else {
            const t = e.currentTarget.getAttribute("href"),
              n = e.currentTarget.getAttribute("target");
            (!!n ? window.open(t, n) : t && (window.location.href = t),
              this.playCarousel());
          }
        }
        handleWPAdminBar() {
        ...
        initScrollingAnimation() {
          const { autoplay: e, animationTypeControl: t } =
            this.getSettings("constants");
    ...
    8243: (e, t, n) => {
      ...
      class ClickTrackingHandler extends i.default {
        ...
        onChatButtonTrackClick(e) {
          ...
          for (const e of s)
            (t.matches(e) || t.closest(e)) && this.getDocumentIdAndTrack(t, n);
          (t.matches(n.contactButtonsVar5) ||
            t.closest(n.contactButtonsVar5)) &&
