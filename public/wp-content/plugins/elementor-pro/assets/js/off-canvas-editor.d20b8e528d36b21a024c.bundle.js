...
(self["webpackChunkelementor_pro"] =
  ...
  \********************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _offCanvas = _interopRequireDefault(
          __webpack_require__(
            /*! ./off-canvas */ "../modules/off-canvas/assets/js/editor/off-canvas.js",
          ),
        );
        class Module extends elementorModules.editor.utils.Module {
          constructor() {
            ...
            elementor.elementsManager.registerElementType(
              new _offCanvas.default(),
            );
            elementor.listenTo(
              elementor.channels.editor,
              "all",
              this.populateOffCanvasDropdownOptions,
            );
          }
          showOffCanvas() {
          ...
          populateOffCanvasDropdownOptions = (() => {
            ...
            return function (eventName) {
              ...
              const offCanvasWidgets =
                  _this.getOffCanvasWidgetsForCurrentDocument(),
          ...
          getOffCanvasWidgetsForCurrentDocument() {
            return elementor.$previewContents[0].querySelectorAll(
              `[data-elementor-id="${elementor.config.document.id}"] .elementor-widget-off-canvas.elementor-element-edit-mode`,
            );
          }
  ...
  */
          hideAdvancedTab(sectionName, editor) {
            ...
            const advancedTab =
              editor?.el.querySelector(".elementor-tab-control-advanced") ||
              false;
            if (advancedTab) {
          ...
          onInit() {
            ...
            elementor.channels.editor.on(
              "section:activated",
              this.hideAdvancedTab.bind(this),
            );
          }
        }
