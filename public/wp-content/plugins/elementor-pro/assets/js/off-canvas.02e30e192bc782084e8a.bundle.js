        ...
        class OffCanvas extends elementorModules.frontend.handlers.Base {
          ...
          bindEvents() {
            ...
            elementorFrontend.elements.$window.on(
              "keydown",
              this.onCanvasKeyDown.bind(this),
            );
            this.elements.$main.on(
          ...
          handleDisplayToggle(event) {
            ...
            const displayMode = event.originalEvent.detail.displayMode,
              ...
              isKeyboardEvent =
                "" === event?.originalEvent?.detail?.previousEvent?.pointerType;
            if ("open" === displayMode) {
          ...
          onClickOverlay() {
            const elementSettings = this.getElementSettings(),
              isPreventCloseOnOverlay =
                "yes" === elementSettings.is_not_close_on_overlay;
          ...
          maybeOnOpenAnimation() {
            const openAnimationClass =
              this.getResponsiveSetting("entrance_animation") || "none";
          ...
          maybeOnCloseAnimation() {
            const exitAnimationClass =
              this.getResponsiveSetting("exit_animation") || "none";
            if ("none" === exitAnimationClass) {
              this.elements.$wrapper.addClass("no-animation");
            } else {
              this.elements.$wrapper.removeClass("no-animation");
            }
            this.elements.$main.addClass(
              `animated reverse ${exitAnimationClass}`,
            );
          ...
          removeAnimationClasses() {
            ...
            if (isExitAnimation) {
              ...
              this.elements.$body.removeClass(
                "e-off-canvas__no-scroll-animation",
              );
          ...
          isEditingMode() {
            return (
              "yes" === this.getElementSettings("editing_mode") &&
          ...
          getTriggerElements() {
            const links =
                elementorFrontend.elements.window.document.body.querySelectorAll(
                  "a",
                ),
          ...
          handleElementHandlers() {
            ...
            (0, _runElementHandlers.default)(
              this.elements.$main[0].querySelectorAll(".e-off-canvas__content"),
            );
          ...
          addClassToPreviousSiblingInsideASection() {
            const isInsideSection =
              this.$element[0].closest(".elementor-section");
            if (!isInsideSection) {
              return;
            }
