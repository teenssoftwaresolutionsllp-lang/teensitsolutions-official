(!(function () {
  ...
  var d = C.forwardRef((e, n) =>
    C.createElement(
      c.SvgIcon,
      u({ viewBox: "0 0 24 24" }, e, { ref: n }),
  ...
  var s = C.forwardRef((e, n) =>
      C.createElement(
        c.SvgIcon,
        l({ viewBox: "0 0 24 24" }, e, { ref: n }),
        C.createElement("path", {
          fillRule: "evenodd",
          clipRule: "evenodd",
    ...
    a = window.elementorV2.editorDocuments;
  function p() {
    const e = (function () {
        const e = (0, a.__useActiveDocument)(),
          n = (0, t.__useSelector)(
            (n) => (e && n.documentsExtended.entities[e.id]) || null,
          );
        return n ? { ...e, ...n } : null;
      })(),
      n = !!e?.locationKey;
    return {
      icon: d,
      title: (0, r.__)("Display Conditions", "elementor-pro"),
      visible: n,
      onClick: () => {
        (0, i.__privateOpenRoute)("theme-builder-publish/conditions");
      },
    };
  }
  var m = window.elementorV2.icons;
  function V() {
    const e = (0, a.__useActiveDocument)(),
      n = "popup" === e?.type.value;
    return {
      icon: m.SettingsIcon,
      title: (0, r.__)("Advanced Rules", "elementor-pro"),
      visible: n,
      onClick: () => {
        (0, i.__privateOpenRoute)("theme-builder-publish/timing");
      },
    };
  }
  function v() {
    ...
    return {
      icon: s,
      title: (0, r.__)("Triggers", "elementor-pro"),
      visible: n,
      onClick: () => {
        (0, i.__privateOpenRoute)("theme-builder-publish/triggers");
      },
    };
  }
  const f = (0, t.__createSlice)({
  ...
  function g() {
    (o.documentOptionsMenu.registerAction({
      id: "popup-triggers",
      priority: 20,
      useProps: v,
    }),
      ...
      (0, t.__registerSlice)(f),
      (function () {
        const { init: e } = f.actions;
        (0, i.__privateListenTo)((0, i.v1ReadyEvent)(), () => {
          const n = _(),
            o = Object.entries(n.documents).reduce(
              (e, [n, t]) => ((e[n] = w(t)), e),
              {},
            );
          (0, t.__dispatch)(e({ entities: o }));
        });
      })(),
      (function () {
        const { addDocument: e } = f.actions;
        (0, i.__privateListenTo)(
          (0, i.commandEndEvent)("editor/documents/open"),
          () => {
            const n = w(_().getCurrent());
            (0, t.__dispatch)(e(n));
          },
        );
      })());
  }
  (window.elementorV2 = window.elementorV2 || {}).editorDocumentsExtended = n;
})(),
