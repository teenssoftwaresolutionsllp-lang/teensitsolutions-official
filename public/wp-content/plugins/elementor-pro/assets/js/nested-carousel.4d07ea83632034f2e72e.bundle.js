      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
          ...
          extends elementorModules.frontend.handlers.CarouselBase
        {
          ...
          handleElementHandlers() {
            ...
            const duplicatedSlides = Array.from(this.swiper.slides).filter(
              (slide) =>
                slide.classList.contains(
                  this.swiper.params.slideDuplicateClass,
                ),
            );
          ...
          wrapSlideContent() {
            ...
            let index = 1;
            this.findElement(
              `${settings.selectors.slidesWrapper} > .e-con`,
            ).each(function () {
          ...
          async linkContainer(event) {
            ...
            if (id === currentId) {
              ...
              switch (type) {
                case "move":
                  [carouselItemWrapper, contentContainer] = this.move(
                    view,
                    index,
                    targetContainer,
                    $slides,
                  ...
                  break;
                case "duplicate":
                  [carouselItemWrapper, contentContainer] = this.duplicate(
                    view,
                    index,
                    targetContainer,
                    $slides,
