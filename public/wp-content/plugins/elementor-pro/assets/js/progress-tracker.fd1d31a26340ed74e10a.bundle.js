        ...
        class CircularProgress {
          ...
          updateProgress(progress) {
            ...
            this.elements.circularCurrentProgressPercentage.style.display =
              "block";
            const radius =
                this.elements.circularCurrentProgress.r.baseVal.value,
        ...
        class LinearProgress {
          ...
          cacheElements() {
            return {
              ...
              linearCurrentProgressPercentage:
                this.linearCurrentProgressPercentage,
            };
          }
          updateProgress(progress) {
            ...
            if (
              ...
              this.elements.linearCurrentProgress.getBoundingClientRect()
                .width >
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class ProgressTracker extends elementorModules.frontend.handlers.Base {
          ...
          getTrackingElementSelector() {
            const trackingElementSetting =
              this.getElementSettings().relative_to;
            let selector;
