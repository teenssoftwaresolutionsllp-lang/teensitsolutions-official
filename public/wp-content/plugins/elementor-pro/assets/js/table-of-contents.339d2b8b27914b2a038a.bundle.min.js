    ...
    3827: (e, t, s) => {
      ...
      class TOCHandler extends elementorModules.frontend.handlers.Base {
        ...
        getDefaultElements() {
          ...
          let t = this.$element.find(e.selectors.widgetContainer);
          return (
            0 === t.length && (t = this.$element),
            {
                ...
                : e.isIntersecting && a
                  ? (delete this.viewportItems[o],
                    Object.keys(this.viewportItems).length &&
                      this.activateItem(this.$listItemTexts.eq(n + 1)))
                  : a ||
                    (delete this.viewportItems[o],
                    this.activateItem(this.$listItemTexts.eq(n - 1))),
                (l = s <= 0 ? 0 : s));
        ...
        getNestedLevel(e) {
          ...
          for (; this.listItemPointer < this.headingsData.length;) {
            ...
            if (
              ...
              break;
            if (e === o.level) {
              ((a += `<li class="${t.classes.listItem}">`),
                (a += `<div class="${t.classes.listTextWrapper}">`));
              ...
              (c && e < c.level && (a += this.getNestedLevel(c.level)),
                (a += "</li>"));
            }
          }
