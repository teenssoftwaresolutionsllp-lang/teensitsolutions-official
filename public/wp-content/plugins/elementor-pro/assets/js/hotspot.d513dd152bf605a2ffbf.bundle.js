        ...
        class Hotspot extends elementorModules.frontend.handlers.Base {
          ...
          bindEvents() {
            const tooltipTrigger =
                this.getCurrentDeviceSetting("tooltip_trigger"),
              tooltipTriggerEvent =
                "mouseenter" === tooltipTrigger
                  ? "mouseleave mouseenter"
                  : tooltipTrigger;
            if (tooltipTriggerEvent !== "none") {
              this.elements.$hotspotsExcludesLinks.on(
                tooltipTriggerEvent,
                (event) => this.onHotspotTriggerEvent(event),
              );
            }
          }
          onDeviceModeChange() {
          ...
          onHotspotTriggerEvent(event) {
            ...
            if (
              triggerTooltip &&
              (isHotspotButtonEvent || isTooltipMouseLeave)
            ) {
          ...
          hotspotSequencedAnimation() {
            const elementSettings = this.getElementSettings(),
              isSequencedAnimation =
                elementSettings.hotspot_sequenced_animation;
