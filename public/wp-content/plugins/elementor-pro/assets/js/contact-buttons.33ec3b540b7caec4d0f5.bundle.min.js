    ...
    197: (t, e, n) => {
      ...
      class ContactButtonsHandler extends i.default {
        ...
        onChatButtonTrackClick(t) {
          ...
          for (const t of s)
            (e.matches(t) || e.closest(t)) && this.getDocumentIdAndTrack(e, n);
          (e.matches(n.contactButtonsVar5) ||
            e.closest(n.contactButtonsVar5)) &&
        ...
        getDocumentIdAndTrack(t, e) {
          ...
          (n || (n = t.closest(e.elementorWrapper).dataset.elementorId),
            this.trackClick(n));
        }
        trackClick(t) {
          t &&
        ...
        chatBoxExitAnimation() {
          ...
          o &&
            ...
            this.elements.contentWrapper &&
              this.elements.contentWrapper.classList.add(s));
        }
        openChatBox() {
          const { hasAnimations: t, visible: e } =
            this.getSettings("constants");
        ...
        removeChatButtonAnimationClasses() {
          ...
          const { chatButtonAnimation: t, visible: e } =
            this.getSettings("constants");
          (this.elements.chatButton.classList.remove(t),
            this.elements.chatButton.classList.add(e));
        }
        initChatButtonEntranceAnimation() {
          const { none: t, chatButtonAnimation: e } =
              this.getSettings("constants"),
        ...
        initDefaultState() {
          if (this.elements.contentWrapper) {
            ...
            (this.elements.chatButton &&
              this.elements.chatButton.setAttribute("aria-expanded", !t),
              this.elements.closeButton &&
                this.elements.closeButton.setAttribute("aria-expanded", !t));
          }
          elementorFrontend.isEditMode() &&
