/******/ (() => {
        ...
        class CopyLink extends $e.modules.CommandBase {
          ...
          apply(args) {
            ...
            _services_copy_to_clipboard__WEBPACK_IMPORTED_MODULE_1__.copyToClipboard)(
              _app_models_note__WEBPACK_IMPORTED_MODULE_0__["default"].getURL(
                args.id,
              ),
            );
          }
  ...
  \**************************************/
      /***/ (
        ...
        /* harmony import */ var _close__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./close */ "../assets/js/commands/close.js");
        /* harmony import */ var _copy_link__WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(
            /*! ./copy-link */ "../assets/js/commands/copy-link.js",
          );
        /* harmony import */ var _filter__WEBPACK_IMPORTED_MODULE_3__ =
          __webpack_require__(
            /*! ./filter */ "../assets/js/commands/filter.js",
          );
        /* harmony import */ var _open__WEBPACK_IMPORTED_MODULE_4__ =
          __webpack_require__(/*! ./open */ "../assets/js/commands/open.js");
        /* harmony import */ var _set_active__WEBPACK_IMPORTED_MODULE_5__ =
          __webpack_require__(
            /*! ./set-active */ "../assets/js/commands/set-active.js",
          );
        /* harmony import */ var _toggle__WEBPACK_IMPORTED_MODULE_6__ =
          __webpack_require__(
  ...
  \***********************************/
      /***/ (
        ...
        /* harmony import */ var _hooks___WEBPACK_IMPORTED_MODULE_2__ =
          __webpack_require__(/*! ./hooks/ */ "../assets/js/hooks/index.js");
        ...
        class EComponent extends $e.modules.ComponentBase {
          ...
          defaultData() {
            return this.importCommands(
              _data_commands___WEBPACK_IMPORTED_MODULE_1__,
            );
          }
              ...
              "": {
                ...
                reducers: {
                  ...
                  clearActive: (state, { payload: id } = {}) => {
                    ...
                    const shouldClear =
                      !id || state.active?.data?.noteId === id;
                    if (!shouldClear) {
                      return state;
                    }
                    return {
          ...
          updateEditorState(mode) {
            switch (mode) {
              case this.constructor.NOTES_MODE_OPEN:
                elementor
                  .getPanelView()
                  .modeSwitcher.currentView.setMode("preview");
              ...
              case this.constructor.NOTES_MODE_CLOSE:
                elementor
                  .getPanelView()
                  .modeSwitcher.currentView.setMode("editor");
                break;
              default:
  ...
  \******************************************/
      /***/ (
        ...
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ default: () => __WEBPACK_DEFAULT_EXPORT__,
          /* harmony export */ notesContextMenu: () =>
            /* binding */ notesContextMenu,
          /* harmony export */
        });
        /* provided dependency */ var __ = __webpack_require__(
          /*! @wordpress/i18n */ "@wordpress/i18n",
  ...
  \*******************************************************************/
      /***/ (
        ...
        function Provider(_ref) {
          ...
          var Context =
            context || _Context__WEBPACK_IMPORTED_MODULE_1__.ReactReduxContext;
...
*/
          ...
          return function wrapWithConnect(WrappedComponent) {
            ...
            function ConnectFunction(props) {
              ...
              var contextValue = (0,
              react__WEBPACK_IMPORTED_MODULE_3__.useContext)(ContextToUse); // The store _must_ exist as either a prop or in context.
              ...
              react__WEBPACK_IMPORTED_MODULE_3__.useRef)(wrapperProps);
              var childPropsFromStoreUpdate = (0,
              react__WEBPACK_IMPORTED_MODULE_3__.useRef)();
              var renderIsScheduled = (0,
              react__WEBPACK_IMPORTED_MODULE_3__.useRef)(false);
 ...
 */
        ...
        function createDispatchHook(context) {
          ...
          var useStore =
            ...
            _components_Context__WEBPACK_IMPORTED_MODULE_0__.ReactReduxContext
              ...
              : (0, _useStore__WEBPACK_IMPORTED_MODULE_1__.createStoreHook)(
                  context,
                );
  ...
  \*****************************************************************/
      /***/ (
        ...
        function useSelectorWithStoreAndSubscription(
          ...
          var _useReducer = (0, react__WEBPACK_IMPORTED_MODULE_0__.useReducer)(
              function (s) {
                return s + 1;
              },
              0,
  ...
  \***********************************************************************/
      /***/ (
        ...
        function verifyPlainObject(value, displayName, methodName) {
          if (
            !(0, _isPlainObject__WEBPACK_IMPORTED_MODULE_0__["default"])(value)
          ) {
  ...
  \*****************************/
    __webpack_require__.r(__webpack_exports__);
    /* harmony import */ var _e_component__WEBPACK_IMPORTED_MODULE_0__ =
      __webpack_require__(/*! ./e-component */ "../assets/js/e-component.js");
