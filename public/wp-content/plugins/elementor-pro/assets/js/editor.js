...
/******/ (() => {
        ...
        module.exports = elementorModules.editor.views.ControlsStack.extend({
          ...
          initialize() {
            this.collection = new Backbone.Collection(
              _.values(this.options.controls),
            );
          },
          filter(model) {
          ...
          const handleElement = createHandleElement(
            {
              title,
              onClick: () =>
                onDocumentClick(id, context, onCloseDocument, selector),
            },
            context,
            element,
          );
      ...
      /***/ (module) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          onSectionActivated(sectionName, editor) {
            ...
            var isSideBSection =
              -1 !==
              ["section_side_b_content", "section_style_b"].indexOf(
                sectionName,
              );
            editedElement.$el.toggleClass(
              "elementor-flip-box--flipped",
              isSideBSection,
            );
            var $backLayer = editedElement.$el.find(
  ...
  \***************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = elementor.modules.controls.Repeater.extend({
          ...
          onRender() {
            elementor.modules.controls.Base.prototype.onRender.apply(
              this,
              arguments,
            );
            var self = this;
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = class extends elementor.modules.controls.Repeater {
          ...
          initialize() {
            ...
            ).listenTo(formFields, "remove", (model) =>
              this.onFormFieldRemove(model),
            );
          }
          getFirstChild() {
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          onSectionActive(sectionName) {
            ...
            if (
              elementor.config.user.dismissed_editor_notices.includes(
          ...
          registerEvents() {
            ...
            const dismissBtn = this.getPromoControl().$el.find(
          ...
          getPromoControl() {
            if (!this.control) {
              this.control = this.getEditorControlView(
                "site_mailer_promo" + this.suffix,
              );
            }
            return this.control;
          },
          ...
          onAction(event) {
            const { action_url: actionURL = null } = JSON.parse(
              event.target.closest("button").dataset.settings,
            );
            if (actionURL) {
          ...
          onInit() {
            elementor.channels.editor.on("section:activated", (sectionName) =>
              this.onSectionActive(sectionName),
            );
          },
        });
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          isNoticeDismissed(noticeName) {
            return elementor.config.user.dismissed_editor_notices.includes(
              noticeName,
            );
          },
          registerEvents() {
          ...
          onAction(event) {
            const { action_url: actionURL = null } = JSON.parse(
              event.currentTarget.dataset.settings,
            );
            if (actionURL) {
              window.open(actionURL, "_blank");
            }
  ...
  \**************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class FormFieldsSanitizeCustomId
        ...
        class FormFieldsSetCustomId extends $e.modules.hookData.After {
          ...
          apply(args, model) {
            ...
            containers.forEach((/** Container */ container) => {
              const itemContainer =
                container.repeaters.form_fields.children.find(
                  (childrenContainer) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          onApiUpdate() {
            const self = this,
              ...
              apiUrlControlView = self.getEditorControlView(
            ...
            self
              .getActiveCampaignCache("lists", "activecampaign_list", cacheKey)
              .done(function (data) {
          ...
          getActiveCampaignCache(type, action, cacheKey, requestArgs) {
            ...
            requestArgs = _.extend({}, requestArgs, {
              ...
              api_url: this.getEditorControlView(
                "activecampaign_api_url",
              ).getControlValue(),
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          onApiUpdate() {
            ...
            self
              .getConvertKitCache("data", "convertkit_get_forms", cacheKey)
              .done(function (data) {
          ...
          updateFieldsMapping() {
            ...
            this.getEditorControlView("convertkit_fields_map").updateMap(
              remoteFields,
            );
          },
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          updateFieldsMapping() {
            ...
            this.getEditorControlView("drip_fields_map").updateMap([
              remoteFields,
            ]);
          },
          getDripCache(type, action, cacheKey, requestArgs) {
            ...
            requestArgs = _.extend({}, requestArgs, {
              service: "drip",
              drip_action: action,
              api_token: this.getEditorControlView(
                "drip_api_token_source",
              ).getControlValue(),
              custom_api_token: this.getEditorControlView(
                "drip_custom_api_token",
              ).getControlValue(),
            });
            return this.fetchCache(type, cacheKey, requestArgs);
  ...
  \*********************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          onApiUpdate() {
            var self = this,
              controlView = self.getEditorControlView(
          ...
          updatGetResonseList() {
            ...
            self
              ...
              .done(function (data) {
                self
                  .getEditorControlView("getresponse_fields_map")
          ...
          onSectionActive() {
            BaseIntegrationModule.prototype.onSectionActive.apply(
              this,
              arguments,
            );
            this.updatGetResonseList();
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          updatMailchimpList() {
            ...
            self
              .getMailchimpCache(...Object.values(args))
              .done(function (data) {
                self
                  .getEditorControlView("mailchimp_fields_map")
                  .updateMap(data.fields);
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = BaseIntegrationModule.extend({
          ...
          onMailerliteApiKeyUpdate() {
            ...
            self
              .getMailerliteCache("groups", "groups", cacheKey)
              .done(function (data) {
          ...
          updateFieldsMapping() {
            ...
            this.getEditorControlView("mailerlite_fields_map").updateMap(
              remoteFields,
            );
          },
        ...
        class FormsModule extends elementorModules.editor.utils.Module {
          onElementorInit() {
            const ReplyToField = __webpack_require__(
              ...
              SubmissionAnalysis = __webpack_require__(
                /*! ./hints/submission-analysis */ "../modules/forms/assets/js/editor/hints/submission-analysis.js",
              );
      ...
      /***/ (module) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          enqueueRecaptchaJs(url, type) {
            if (
              !elementorFrontend.elements.$body.find('[src="' + url + '"]')
                .length
            ) {
          ...
          renderField(inputField, item) {
            inputField +=
              '<div class="elementor-field ' + item.field_type + ' ">';
        ...
        class Link extends $e.modules.editor.document.CommandHistoryBase {
          ...
          apply(args) {
            ...
            containers.forEach((/** Container */ container) => {
              ...
              const elementModel =
                  elementorPro.modules.globalWidget.addGlobalWidget(
                    data.template_id,
                    data,
                  ),
          ...
          async apply(args) {
            ...
            containers.forEach((/** Container */ container) => {
              const id = container.model.get("templateID"),
                elementModel =
                  elementorPro.modules.globalWidget.createGlobalModel(
                    id,
                    data[id],
                  );
              $e.run("document/elements/create", {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class Component extends $e.modules.ComponentBase {
          ...
          updateGlobalsRecursive(targetContainer) {
            ...
            elementor
              .getPreviewContainer()
              .forEachChildrenRecursive((container) => {
                // Will skip self.
                if (
  ...
  \************************************************************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class GlobalWidgetPrepareUpdateElementSetSettings
          extends _baseGlobalWidgetPrepareUpdate.BaseGlobalWidgetPrepareUpdate
        {
          getCommand() {
  ...
  \*************************************************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports["default"] = exports.GlobalWidgetPrepareUpdateRepeaterInsert =
          void 0;
        ...
        class GlobalWidgetPrepareUpdateRepeaterInsert
          extends _baseGlobalWidgetPrepareUpdate.default
        {
          getCommand() {
            return "document/repeater/insert";
          }
  ...
  \*************************************************************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports["default"] = exports.GlobalWidgetPrepareUpdateRepeaterRemove =
          void 0;
        var _baseGlobalWidgetPrepareUpdate = __webpack_require__(
          /*! ../../../base-global-widget-prepare-update */ "../modules/global-widget/assets/js/editor/hooks/data/base-global-widget-prepare-update.js",
        );
        ...
        class GlobalWidgetPrepareUpdateRepeaterRemove
          extends _baseGlobalWidgetPrepareUpdate.BaseGlobalWidgetPrepareUpdate
        {
          getCommand() {
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class GlobalWidgetSaveTemplates extends $e.modules.hookData.After {
          ...
          getConditions(args) {
            if (
              !Object.keys(
                $e.components.get("document/global").changedContainersId,
              ).length
            ) {
              return false;
            }
        ...
        class GlobalWidgetHistoryUpdate extends $e.modules.hookUI.After {
          ...
          apply(args) {
            ...
            containers.forEach((container) =>
              $e.components
                .get("document/global")
                .updateGlobalsRecursive(container),
            );
          }
        }
        ...
        class Module extends elementorModules.editor.utils.Module {
          ...
          onElementorPreviewLoaded(isFirst) {
            ...
            $e.routes.register("panel/editor", "global", (args) => {
              elementor
                .getPanelView()
                .setPage("globalWidget", "Global Editing", {
  ...
  \***********************************************************************/
      /***/ (module) => {
        ...
        var GlobalWidgetsView =
          elementor.modules.layouts.panel.pages.elements.views.Global;
  ...
  \*********************************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = Marionette.ItemView.extend({
          ...
          ui: {
            editButton:
              "#elementor-global-widget-locked-edit .elementor-button",
            unlinkButton:
        ...
        class Model extends ElementModel {
          ...
          initSettingsFromTemplate() {
            const id = this.get("templateID"),
              ...
              elementModel =
                elementorPro.modules.globalWidget.createGlobalModel(id, data);
        ...
        class View extends WidgetView {
          ...
          removeInlineAddingAttributes() {
            ...
            if (globalWidgetElementDom) {
              globalWidgetElementDom.classList.remove(
                "elementor-inline-editing",
              );
            }
          }
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = function () {
          ...
          self.onPanelShow = function (panel) {
            ...
            self.templateIdView =
              panel.content.currentView.children.findByModelCid(model.cid);
          ...
          self.onTemplateIdChange = function () {
            var templateID =
              ...
              $editButton = self.templateIdView.$el.find(
  ...
  \************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class LoopBuilderBehavior extends Marionette.Behavior {
          ui() {
            return {
              postSourceControlSelector:
                '[data-setting="post_taxonomy_query_post_type"]',
              productSourceControlSelector:
                '[data-setting="product_taxonomy_query_post_type"]',
            };
          }
          events() {
            return {
          ...
          onApplySourceChange(event) {
            const sourceType =
              event.target?.value || this.getDefaultSourceType();
  ...
  \**********************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _behavior = _interopRequireDefault(
          __webpack_require__(
            /*! ./behavior */ "../modules/loop-builder/assets/js/editor/behavior.js",
          ),
        );
        function _getRequireWildcardCache(e) {
          if ("function" != typeof WeakMap) return null;
        ...
        class loopBuilderModule extends elementorModules.editor.utils.Module {
          ...
          registerControlBehavior = (() => {
            ...
            return function () {
              ...
              const taxonomyQueryOptions = [
                "post_taxonomy_query_post_type",
                "product_taxonomy_query_post_type",
              ];
              if (
                !taxonomyQueryOptions.includes(view.options.model.get("name"))
              ) {
                return behaviors;
              }
              behaviors.loopBuilder = {
                ...
                updateTaxonomyTabsIdControls:
                  _this.updateTaxonomyTabsIdControls,
              };
              return behaviors;
            };
          })();
          ...
          getSourceControlValue = () => {
            const skinType = this.getSkinType(),
              controlView = this.getEditorControlView(
                `${skinType}_query_post_type`,
              );
            if (!controlView) {
          ...
          updateTaxonomyTabsIdControls = (() => {
            ...
            return function (postType) {
              ...
              const querySectionView =
                  elementorPro.modules.loopBuilder.getEditorControlView(
                    "section_query",
                  ),
              ...
              [includeIds, excludeIds].forEach((control) => {
                const controlView = elementor
                  .getPanelView()
                  ?.getCurrentPageView()
                  ?.children?.findByModel(control);
          ...
          updateControlQuery = (_ref2) => {
            let { control, controlView, postType, shouldResetControlValues } =
              _ref2;
            control.set({
              autocomplete: {
                object: "tax",
        ...
        class notesContextMenu {
          ...
          notesContextMenuAddGroup(groups) {
            ...
            const openNotesAction = _.findWhere(notesGroup.actions, {
              ...
              openNotesActionIndex =
                notesGroup.actions.indexOf(openNotesAction);
            groups[notesGroupIndex].actions[openNotesActionIndex] =
              notesActionItem;
            return groups;
          }
        }
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        function getPageTransitionSettings(container) {
          ...
          const controls = Object.entries(
            container.settings.getActiveControls(),
          ).filter((_ref) => {
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class _default extends elementorModules.editor.utils.Module {
          ...
          onAnimateButtonClick() {
            elementor.channels.editor.on(
              "elementorPageTransitions:animate",
              () => {
                $e.run("page-transitions/animate");
              },
            );
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class _default extends elementorModules.editor.views.ControlsStack {
          ...
          toggleGroup(groupName, $groupElement) {
            $groupElement.toggleClass(
              "elementor-active",
              !!this.model.get(groupName),
            );
          }
          onRenderTemplate() {
          ...
          onModelChange() {
            const changedControlName = Object.keys(this.model.changed)[0],
              changedControlView =
                this.getControlViewByName(changedControlName);
            if ("switcher" !== changedControlView.model.get("type")) {
              return;
            }
            this.toggleGroup(
              changedControlName,
              changedControlView.$el.parent(),
            );
          }
        }
        exports["default"] = _default;
        ...
        class PopupAddTriggers extends $e.modules.hookUI.After {
          ...
          addPublishTabs() {
            ...
            jQuery.each(module.displaySettingsTypes, (type, data) => {
              ...
              data.model =
                new elementorModules.editor.elements.models.BaseSettings(
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          onElementorPreviewLoaded() {
            ...
            __webpack_require__
              ...
              .then((_ref) => {
                let { default: TemplateQueryControl } = _ref;
                return elementor.addControlView(
                  "template_query",
      ...
      /***/ (module) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          getNetworkClass(networkName) {
            let networkClass =
              this.networksClassDictionary[networkName] ||
              "fab fa-" + networkName;
          ...
          getNetworkTitle(buttonSettings) {
            ...
            return (
              buttonSettings.text || this.getNetworkData(buttonSettings)?.title
            );
          },
        ...
        module.exports = elementor.modules.controls.RepeaterRow.extend({
          ...
          checkConflicts() {
            var modelId = this.model.get("_id"),
              ...
              errorMessageId =
                "elementor-conditions-conflict-message-" + modelId,
          ...
          onRender() {
            var nameModel = this.collection.findWhere({
              ...
              conditionConfig =
                this.config.conditions[this.model.attributes.name],
              subConditionConfig =
                this.config.conditions[this.model.attributes.sub_name],
              typeConfig =
                this.config.types[this.config.settings.template_type];
            if (
  ...
  \*****************************************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class ThemeBuilderUpdatePreviewOptions
          extends $e.modules.hookData.After
        {
          getCommand() {
            return "document/elements/settings";
          }
        ...
        exports.ThemeBuilderUpdatePreviewOptions =
          ThemeBuilderUpdatePreviewOptions;
  ...
  \*********************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class ThemeBuilderShowConditions
          extends $e.modules.hookData.Dependency
        {
          getCommand() {
  ...
  \**********************************************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        exports.ThemeBuilderToggleMenuConditions =
          ThemeBuilderToggleMenuConditions;
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class ThemeBuilderAddEditorUI extends $e.modules.hookUI.After {
          ...
          addPublishTabs() {
            ...
            component.manager.conditionsModel =
              new elementorModules.editor.elements.models.BaseSettings(
                ...
                {
                  controls:
                    themeBuilderModuleConfig.template_conditions.controls,
                },
              );
          ...
          addPanelFooterSubmenuItems() {
            ...
            footerView.ui.menuConditions = footerView.addSubMenuItem(
              "saver-options",
              {
                before: "save-template",
                name: "conditions",
            ...
            behavior.ui.buttonPreview
              .tipsy("disable")
              .html(
                jQuery("#tmpl-elementor-theme-builder-button-preview").html(),
              )
              .addClass(
                "elementor-panel-footer-theme-builder-buttons-wrapper elementor-toggle-state",
              );
  ...
  \************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class ThemeBuilderFooterSaverAfterSave extends $e.modules.hookUI.After {
          ...
          onPageStatusChange(newStatus) {
            ...
            const options = {
              ...
              message:
                elementor.config.document.panel.messages.publish_notification,
              buttons: [
                {
        ...
        exports.ThemeBuilderFooterSaverAfterSave =
        ...
        class ThemeBuilderModule extends elementorModules.editor.utils.Module {
          ...
          updatePreviewIdOptions = (render) => {
            ...
            if (true === render) {
              // Can be model.
              const controlView =
                currentView.children.findByModel(controlModel);
              controlView.render();
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class Component extends $e.modules.ComponentModalBase {
          ...
          renderTab(tab) {
            ...
            this.layout.modal
              .getElements("publish")
              .toggleClass("e-primary", isLastTab);
          }
          activateTab(tab) {
        ...
        class _default extends Marionette.LayoutView {
          ...
          getTemplate() {
            return Marionette.TemplateCache.get(
              "#tmpl-elementor-component-publish",
            );
          }
          regions() {
            return {
  ...
  \****************************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class ActiveTab extends $e.modules.hookData.After {
          ...
          getConditions(args) {
            return (
              args.settings.inner_tab_content_1 ||
              args.settings.inner_tab_content_2
            );
          }
          apply(args) {
            if (args.settings.inner_tab_content_1) {
              args.container.view.model
                .get("editSettings")
                .set("innerActiveIndex", 0);
            } else if (args.settings.inner_tab_content_2) {
              args.container.view.model
                .get("editSettings")
                .set("innerActiveIndex", 1);
            }
          }
        }
      ...
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        module.exports = elementorModules.editor.utils.Module.extend({
          ...
          getPromoControl() {
            if (
              !this.control &&
              !!this.getEditorControlModel("send_app_promo" + this.suffix)
            ) {
              this.control = this.getEditorControlView(
                "send_app_promo" + this.suffix,
              );
          ...
          onElementorInit() {
            elementor.channels.editor.on(
              "section:activated",
              (sectionName, editor) =>
                this.onSectionActive(sectionName, editor),
            );
          },
        });
  ...
  \***************************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class WoocommerceCreateWidgetActivateSettingsModal
          extends $e.modules.hookData.After
        {
          getCommand() {
  ...
  \*****************************************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class WoocommerceDeleteWidgetDeactivateSettingsModal
          extends $e.modules.hookData.After
        {
          getCommand() {
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class WoocommerceNotices extends $e.modules.hookData.After {
          ...
          apply(args) {
            ...
            woocommerce.renderMockNotices(
              args.settings.woocommerce_notices_elements,
            );
          }
        }
  ...
  \*****************************************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        class WoocommerceSaveShowModal extends $e.modules.hookData.After {
          ...
          getConditions(args) {
            return (
              args.status && -1 !== ["private", "publish"].indexOf(args.status)
            );
          }
          apply() {
  ...
  \*********************************************************/
      /***/ (module, __unused_webpack_exports, __webpack_require__) => {
        ...
        var _storeTracking = _interopRequireDefault(
          __webpack_require__(
            /*! ./hints/store-tracking */ "../modules/woocommerce/assets/js/editor/hints/store-tracking.js",
          ),
        );
        class WoocommerceModule extends elementorModules.editor.utils.Module {
          ...
          onUpdateDocument() {
            ...
            const lastWidgetCreatedOptions =
              this.pageSettingsWidgets[lastWidgetCreated];
          ...
          onConfirmModal(lastWidgetCreatedOptions) {
            elementorPro.ajax.addRequest("woocommerce_update_page_option", {
              ...
              error: () =>
                this.showPagesSettingsToast(
                  lastWidgetCreatedOptions.failedMessage,
                ),
            });
          }
          ...
          openSiteSettingsTab() {
            ...
            $e.run("editor/documents/switch", {
              ...
              .then(() => {
                if (sectionId) {
                  const sectionElement = jQuery(
                    ".elementor-control-" + sectionId,
                  );
...
*/
  ...
  /******/ (() => {
    ...
    /******/ __webpack_require__.u = (chunkId) => {
      ...
      /******/ if (chunkId === "mega-menu-editor")
        return "" + chunkId + ".e043cd3d7fd180995eb9.bundle.js";
      /******/ if (chunkId === "nested-carousel-editor")
        return "" + chunkId + ".0df35e0e1a284d4bd18b.bundle.js";
      /******/ if (chunkId === "loop-filter-editor")
        return "" + chunkId + ".46a4c013b80a381a50c9.bundle.js";
      /******/ if (chunkId === "off-canvas-editor")
        return "" + chunkId + ".d20b8e528d36b21a024c.bundle.js";
      /******/ if (
        chunkId ===
        "modules_query-control_assets_js_editor_template-query-control_js"
      )
        return "1644e3d37816d939acca.bundle.js";
  ...
  \*****************************************/
    ...
    var _tiers = __webpack_require__(
      /*! ./tiers */ "../assets/dev/js/editor/tiers.js",
    );
    ...
    var ElementorPro = Marionette.Application.extend({
      ...
      getProButtonViewIdBC(viewID, templateData) {
        ...
        if (
          templateData.accessLevel >
          elementor.config.library_connect.current_access_level
        ) {
          return viewID;
        }
