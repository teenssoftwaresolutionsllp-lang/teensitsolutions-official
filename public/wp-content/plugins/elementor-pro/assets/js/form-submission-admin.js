...
/******/ (() => {
  ...
  \********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const buttonContentOptions = {
          ...
          [_useExport.EXPORT_MODE_SELECTED]: __(
              ...
              /*#__PURE__*/ _react.default.createElement(
                ...
                /*#__PURE__*/ _react.default.createElement(
                  NavigateNextElement,
                  {
                    className: `tablenav-pages-navspan button ${!canNavigateNext && "disabled"}`,
                    onClick: (e) =>
                      navigate(e, canNavigateNext, props.lastPage),
                  },
                  "\xBB",
                ),
              ),
  ...
  \*********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function SubmissionRow(props) {
          ...
          const mainValue =
            props.item?.main?.value || __("Unknown", "elementor-pro");
          return /*#__PURE__*/ _react.default.createElement(
  ...
  \********************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Checkbox(props) {
          ...
          const options = (0, _useFormFieldOptions.default)(
            props.field.options,
          );
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Time(props) {
          return /*#__PURE__*/ _react.default.createElement(
            ...
            props.value &&
              (0, _date.formatToLocalTime)(`2000-01-01 ${props.value}`),
          );
        }
        Time.propTypes = {
          ..._index.basePropTypes,
  ...
  \*******************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const { createContext, useState, useCallback, useContext } =
          _react.default;
        ...
        function NoticesProvider(props) {
          ...
          const notify = useCallback((_ref) => {
            let { message, undoAction, type, dismissible = true } = _ref;
            if (!message) {
              return;
            }
  ...
  \************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        const EXPORT_MODE_SELECTED = (exports.EXPORT_MODE_SELECTED =
          "selected");
        const EXPORT_MODE_FILTERED = (exports.EXPORT_MODE_FILTERED =
          "filtered");
        const { useState, useMemo } = React;
        const ZIP_NAME_FORMAT = "elementor-submissions-export-{DATE}";
        const EXPORT_FILE_NAME_FORMAT =
          "elementor-submissions-export-{FORM_LABEL}-{DATE}";
        ...
        function useExport(hookOptions) {
          ...
          const mode = useMemo(() => {
            ...
            const filter = Object.fromEntries(
              Object.entries(options.filter).filter((_ref) => {
                let [, value] = _ref;
                return value;
              }),
            );
          ...
          _useDataAction.default)(
            (_ref2, _ref3) => {
              ...
              let { abortController, status } = _ref3;
              ...
              const numberOfRequests = Math.ceil(
                total / options.maxRowsPerRequest,
              );
              ...
              return promise
                .then(() =>
                  downloadExportsResults(Object.values(exportDataByForm)),
                )
        ...
        function downloadExportsResults(dataResults) {
          ...
          __webpack_require__
            ...
            .then((_ref4) => {
              let { default: JSZip } = _ref4;
              const zip = new JSZip();
              files.forEach((_ref5) => {
                let { filename, blob } = _ref5;
  ...
  \********************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function useRestDataList(command) {
          ...
          const [fetchData, { status: fetchDataStatus }] = (0,
          _useDataAction.default)(
            (args, _ref) => {
              let { abortController } = _ref;
              return $e.data
  ...
  \***********************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _default = (exports["default"] = {
          ...
          actionLogs: {
            success: () =>
              __("Action completed successfully.", "elementor-pro"),
            failed: () =>
              __(
  ...
  \*******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Index() {
          const { notifyError, notifySuccess } = (0,
          _noticesContext.useNoticesContext)();
          ...
          const [updateRead] = (0, _useDataAction.default)((_ref, _ref2) => {
            ...
            let { abortController } = _ref2;
            if (!validateRestAction(query)) {
              return Promise.reject();
            }
            const messages =
              _noticeMessages.default[
                isRead ? "markedAsRead" : "markedAsUnread"
              ];
            return $e.data
              .update(
          ...
          const [restoreItems] = (0, _useDataAction.default)((_ref3, _ref4) => {
            ...
            return $e.data
              ...
              .then(fetchData)
              .catch(() =>
                notifyError(_noticeMessages.default.restored.error()),
              );
          });
          const [deleteItems] = (0, _useDataAction.default)((_ref5, _ref6) => {
            let [query] = _ref5;
            let { abortController } = _ref6;
            if (!validateRestAction(query)) {
              return Promise.reject();
            }
            const messages =
          ...
          const rowActions = useMemo(
            () => [
              ...
              },
              {
                ...
                shouldShow: (item) =>
                  "trash" === item.status || !isTrashEnabled,
                className: "trash",
              },
              {
                key: "read",
  ...
  \******************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        function Item(props) {
          ...
          // Update field values.
          const [update, { status: updateStatus }] = (0,
          _useDataAction.default)(
            (_ref3) => {
              let [values] = _ref3;
              return $e.data
                ...
                .catch(() =>
                  notifyError(_noticeMessages.default.updated.error()),
                );
            },
            [props.id],
          );
...
*/
  ...
  \**********************************************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ createHashSource: () =>
            /* binding */ createHashSource,
          /* harmony export */
        });
        // take some code from
...
*/
  ...
  \*************************************************************/
    ...
    var _app = _interopRequireDefault(
      __webpack_require__(
        /*! ./app */ "../modules/forms/submissions/assets/js/admin/app.js",
      ),
    );
