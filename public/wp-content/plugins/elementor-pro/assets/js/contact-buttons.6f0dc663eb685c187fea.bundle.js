        ...
        class ContactButtonsHandler extends _base.default {
          ...
          getDefaultElements() {
            ...
            return {
              ...
              contentWrapper: this.$element[0].querySelector(
          ...
          getDocumentIdAndTrack(targetElement, selectors) {
            let documentId = targetElement.closest(selectors.main).dataset
              .documentId;
            if (!documentId) {
              documentId = targetElement.closest(selectors.elementorWrapper)
                .dataset.elementorId;
            }
          ...
          sendClicks() {
            ...
            this.clicks.forEach((documentId) =>
              formData.append("clicks[]", documentId),
            );
          ...
          removeAnimationClasses() {
            ...
            const isExitAnimation =
                this.elements.content.classList.contains(reverse),
          ...
          chatBoxEntranceAnimation() {
            const { entranceAnimation, animated, animatedWrapper, none } =
              this.getSettings("constants");
            const entranceAnimationControl =
              this.getResponsiveSetting(entranceAnimation);
            if (
              !entranceAnimationControl ||
              none === entranceAnimationControl
            ) {
              return;
            }
            if (this.elements.content) {
          ...
          chatBoxExitAnimation() {
            const { reverse, exitAnimation, animated, animatedWrapper, none } =
              this.getSettings("constants");
            const exitAnimationControl =
              this.getResponsiveSetting(exitAnimation);
          ...
          openChatBox() {
            ...
            if (
              this.elements.main &&
              this.elements.main.classList.contains(hasAnimations)
            ) {
          ...
          initMessageBubbleTime() {
            ...
            const messageBubbleTimeFormat =
              this.elements.messageBubbleTime.dataset.timeFormat;
          ...
          removeChatButtonAnimationClasses() {
            ...
            const { chatButtonAnimation, visible } =
              this.getSettings("constants");
          ...
          initChatButtonEntranceAnimation() {
            ...
            const entranceAnimationControl =
              this.getResponsiveSetting(chatButtonAnimation);
            if (
              !entranceAnimationControl ||
              none === entranceAnimationControl
            ) {
          ...
          initDefaultState() {
            ...
            if (this.elements.contentWrapper) {
              ...
              if (this.elements.closeButton) {
                this.elements.closeButton.setAttribute(
                  "aria-expanded",
                  !isHidden,
                );
              }
          ...
          onInit() {
            ...
            if (this.elements.chatButton) {
              if (
                this.elements.chatButton.classList.contains(
        ...
        class ClickTrackingHandler extends _base.default {
          ...
          getDefaultElements() {
            ...
            return {
              ...
              contentWrapperFloatingBars: this.$element[0].querySelector(
                selectors.contentWrapperFloatingBars,
              ),
              contactButtonsVar5: this.$element[0].querySelector(
                selectors.contactButtonsVar5,
              ),
              contactButtonsVar6: this.$element[0].querySelector(
                selectors.contactButtonsVar6,
              ),
            };
          }
          bindEvents() {
            ...
            if (this.elements.contactButtonsVar5) {
              this.elements.contactButtonsVar5.addEventListener(
                "click",
                this.onChatButtonTrackClick.bind(this),
              );
            }
            if (this.elements.contactButtonsVar6) {
              this.elements.contactButtonsVar6.addEventListener(
                "click",
                this.onChatButtonTrackClick.bind(this),
              );
            }
          ...
          getDocumentIdAndTrack(targetElement, selectors) {
            const documentId = targetElement.closest(selectors.elementorWrapper)
              .dataset.elementorId;
            this.trackClick(documentId);
          }
          trackClick(documentId) {
