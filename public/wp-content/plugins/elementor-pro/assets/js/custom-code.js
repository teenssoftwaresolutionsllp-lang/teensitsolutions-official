    ...
    class CustomCode extends elementorModules.Module {
      ...
      addLocationChangeHandler() {
        jQuery("#location").on("change", (e) => {
          this.setOptionsPlacementVisibility(
            "elementor_body_end" === e.target.value,
          );
        });
      }
      addOpenAIButton() {
        ...
        jQuery(".elementor-field.location.elementor-field-select").after(
          $buttonOpenAI,
        );
      }
      setOptionsPlacementVisibility(state) {
        const $optionsPlacement = jQuery(
          ".elementor-custom-code-options-placement",
        );
