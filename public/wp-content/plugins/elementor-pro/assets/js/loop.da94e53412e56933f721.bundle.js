      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        class Loop extends _posts.default {
          ...
          getDefaultSettings() {
            ...
            defaultSettings.selectors.post =
              ".elementor-loop-container .elementor";
            defaultSettings.selectors.postsContainer =
            ...
            const elementSettings = this.getElementSettings(),
              ...
              editHandleSelector =
                ...
                elementSettings?.edit_handle_selector
                  ...
                  : ""),
              editHandleElement = this.$element
                .find(editHandleSelector)
                .first()[0];
          ...
          handleCTA() {
            ...
            shadowRoot.appendChild(
              elementorPro.modules.loopBuilder.getCtaStyles(),
            );
            shadowRoot.appendChild(
            ...
            const ctaButton = shadowRoot.querySelector(
          ...
          reInitMasonry() {
            ...
            this.elements.$posts = jQuery(
              `.elementor-element-${this.getID()} ${selectors.post}`,
            );
            super.runMasonry();
          }
          unbindEvents() {
