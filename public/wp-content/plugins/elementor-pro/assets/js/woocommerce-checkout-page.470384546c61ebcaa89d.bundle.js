      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        class Base extends elementorModules.frontend.handlers.Base {
          ...
          getDefaultElements() {
            ...
            return {
              $stickyRightColumn: this.$element.find(
                selectors.stickyRightColumn,
              ),
            };
          }
          bindEvents() {
          ...
          activateStickyRightColumn() {
            ...
            let stickyOptionsOffset =
              elementSettings.sticky_right_column_offset || 0;
            ...
            if ("yes" === this.getElementSettings("sticky_right_column")) {
              ...
              this.elements.$stickyRightColumn.css(
                "top",
                stickyOptionsOffset + "px",
              );
            }
          }
          ...
          updateWpReferers() {
            const selectors = this.getSettings("selectors"),
              wpHttpRefererInputs = this.$element.find(
                selectors.wpHttpRefererInputs,
              ),
          ...
          applyCoupon() {
            ...
            jQuery.ajax({
              ...
              success(code) {
                ...
                if (
                  code.includes("woocommerce-error") ||
