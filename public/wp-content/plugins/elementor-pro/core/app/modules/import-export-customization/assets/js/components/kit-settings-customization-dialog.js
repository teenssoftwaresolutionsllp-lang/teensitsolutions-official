  ...
  useEffect(() => {
    if (open) {
      window.elementorModules?.appsEventTracking?.AppsEventTracking?.sendPageViewsWebsiteTemplates(
        elementorCommon.eventsManager.config.secondaryLocations.kitLibrary
          .kitExportCustomizationEdit,
      );
    }
  }, [open]);
  ...
  return (
    ...
    >
      <Stack sx={{ position: "relative" }} gap={2}>
        {isOldElementorVersion && <UpgradeVersionBanner />}
        <Stack>
          <SettingSection
          ...
          {!isOldExport && (
            <>
              ...
              <SettingSection
                ...
                onSettingChange={handleToggleChange}
                disabled={
                  (isImport && !data?.uploadedData?.manifest?.experiments) ||
                  !isHighTier()
                }
                tooltip={!isHighTier()}
              />
              ...
              >
                <Stack>
                  <SubSetting
                    ...
                    disabled={
                      (isImport &&
                        !data?.uploadedData?.manifest?.["custom-fonts"]) ||
                      !isHighTier()
                    }
                    tooltip={!isHighTier()}
                  />
                  <SubSetting
                    ...
                    disabled={
                      (isImport &&
                        !data?.uploadedData?.manifest?.["custom-icons"]) ||
                      !isHighTier()
                    }
                    tooltip={!isHighTier()}
                  />
                  <SubSetting
                    ...
                    disabled={
                      (isImport &&
                        !data?.uploadedData?.manifest?.["custom-code"]) ||
                      !isHighTier()
                    }
                    tooltip={!isHighTier()}
                  />
