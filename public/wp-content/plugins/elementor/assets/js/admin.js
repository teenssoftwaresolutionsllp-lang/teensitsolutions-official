/******/ (() => {
  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _wpDashboardTracking = _interopRequireWildcard(
          __webpack_require__(
            /*! ../wp-dashboard-tracking */ "../app/assets/js/event-track/wp-dashboard-tracking.js",
          ),
        );
        var _utils = __webpack_require__(
          /*! ./utils */ "../app/assets/js/event-track/dashboard/utils.js",
        );
        var _baseTracking = _interopRequireDefault(
          __webpack_require__(
            /*! ./base-tracking */ "../app/assets/js/event-track/dashboard/base-tracking.js",
          ),
        );
          ...
          return (0, _createClass2.default)(ActionControlTracking, null, [
              ...
              value: function initializeLinkDataIds() {
                ...
                var initializeLinks = function initializeLinks() {
                  ...
                  links.forEach(function (link) {
                    if (
                      _this.isExcludedElement(link) ||
                      _this.isNavigationLink(link) ||
            ...
            },
            {
              ...
              value: function addTrackingAttributesToFilterButtons() {
                ...
                var addDataIdToListTableButtons =
                  function addDataIdToListTableButtons() {
                    var buttonConfigs = [
                      {
                    ...
                    buttonConfigs.forEach(function (config) {
                      ...
                      button.setAttribute(
                        "data-id",
                        ""
                          .concat(screenPrefix, "-button-")
                          .concat(config.suffix),
                      );
                    });
                  };
                if ("loading" === document.readyState) {
            ...
            },
            {
              ...
              value: function isExcludedElement(element) {
                for (
                  var _i = 0,
                    _Object$values = Object.values(EXCLUDED_SELECTORS);
              ...
              value: function attachDelegatedHandlers() {
                ...
                this.addEventListenerTracked(
                  ...
                  function (event) {
                    var _event$target;
                    var base =
                      event.target && 1 === event.target.nodeType
                        ? event.target
                        : (_event$target = event.target) === null ||
                            _event$target === void 0
                          ? void 0
                          : _event$target.parentElement;
                    if (!base) {
                      return;
                    }
                    ...
                    if (toggle && !_this2.isExcludedElement(toggle)) {
                      _this2.trackControl(
                        toggle,
                        _wpDashboardTracking.CONTROL_TYPES.TOGGLE,
                      );
                      return;
                    }
                    var button = base.closest(
                    ...
                    if (button && !_this2.isExcludedElement(button)) {
                      if (FILTER_BUTTON_IDS.includes(button.id)) {
                        _this2.trackControl(
                          button,
                          _wpDashboardTracking.CONTROL_TYPES.FILTER,
                        );
                        return;
                      }
                      _this2.trackControl(
                        button,
                        _wpDashboardTracking.CONTROL_TYPES.BUTTON,
                      );
                      return;
                    }
                    ...
                    if (
                      link &&
                      !_this2.isExcludedElement(link) &&
                      !_this2.isNavigationLink(link)
                    ) {
                      _this2.trackControl(
                        link,
                        _wpDashboardTracking.CONTROL_TYPES.LINK,
                      );
                    }
                  },
                  {
                ...
                this.addEventListenerTracked(
                  ...
                  function (event) {
                    ...
                    if (checkbox && !_this2.isExcludedElement(checkbox)) {
                      _this2.trackControl(
                        checkbox,
                        _wpDashboardTracking.CONTROL_TYPES.CHECKBOX,
                      );
                      return;
                    }
                    ...
                    if (radio && !_this2.isExcludedElement(radio)) {
                      _this2.trackControl(
                        radio,
                        _wpDashboardTracking.CONTROL_TYPES.RADIO,
                      );
                      return;
                    }
                    ...
                    if (select && !_this2.isExcludedElement(select)) {
                      _this2.trackControl(
                        select,
                        _wpDashboardTracking.CONTROL_TYPES.SELECT,
                      );
                    }
                  },
                );
            ...
            },
            {
              ...
              value: function isNavigationLink(link) {
                ...
                var isInNavigation = link.closest(
            ...
            },
            {
              ...
              value: function trackControl(element, controlType) {
                var controlIdentifier = this.extractControlIdentifier(
                  element,
                  controlType,
                );
                ...
                _wpDashboardTracking.default.trackActionControl(
                  controlIdentifier,
                  controlType,
                );
              },
            },
            {
              ...
              value: function extractControlIdentifier(element, controlType) {
                ...
                if (
                  _wpDashboardTracking.CONTROL_TYPES.CHECKBOX === controlType
                ) {
                  var _name2 = element.getAttribute("name");
                  if (_name2) {
                    var checkboxesWithSameName = document.querySelectorAll(
                      'input[type="checkbox"][name="'.concat(
                        CSS.escape(_name2),
                        '"]',
                      ),
                    );
                ...
                if (
                  _wpDashboardTracking.CONTROL_TYPES.BUTTON === controlType ||
                  _wpDashboardTracking.CONTROL_TYPES.TOGGLE === controlType ||
                  _wpDashboardTracking.CONTROL_TYPES.FILTER === controlType
                ) {
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _wpDashboardTracking = _interopRequireDefault(
          __webpack_require__(
            /*! ../wp-dashboard-tracking */ "../app/assets/js/event-track/wp-dashboard-tracking.js",
          ),
        );
          ...
          return (0, _createClass2.default)(MenuPromotionTracking, null, [
            ...
            },
            {
              ...
              value: function extractPromoMenuKey(href) {
                for (
                  var _i = 0, _Object$keys = Object.keys(PROMO_MENU_ITEMS);
            ...
            },
            {
              ...
              value: function handleMenuPromoClick(menuItem, menuItemKey) {
                ...
                var path = menuItemKey
                  .replace("elementor_", "")
                  .replace(/_/g, "/");
                _wpDashboardTracking.default.trackPromoClicked(
                  promoName,
                  destination,
                  path,
                );
          ...
          return (0, _createClass2.default)(NavigationTracking, null, [
            ...
            },
            {
              ...
              value: function attachTemplatesMenuTracking() {
                var templatesMenu = document.querySelector(
                  ELEMENTOR_MENU_SELECTORS.TEMPLATES_TOP_LEVEL,
                );
                if (!templatesMenu) {
                  return;
                }
            ...
            },
            {
              ...
              value: function attachElementorHomeMenuTracking() {
                var elementorHomeMenu = document.querySelector(
                  ELEMENTOR_MENU_SELECTORS.ELEMENTOR_HOME_TOP_LEVEL,
                );
            ...
            },
            {
              ...
              value: function attachElementorMenuTracking() {
                var elementorMenu = document.querySelector(
                  ELEMENTOR_MENU_SELECTORS.ELEMENTOR_TOP_LEVEL,
                );
                if (!elementorMenu) {
                  return;
                }
            ...
            },
            {
              ...
              value: function attachSidebarNavigationTracking() {
                var sidebar = document.querySelector(
                  ELEMENTOR_MENU_SELECTORS.SIDEBAR_NAVIGATION,
                );
                if (sidebar) {
            ...
            },
            {
              ...
              value: function handleMenuClick(event, menuName) {
                ...
                _wpDashboardTracking.default.trackNavClicked(
                  itemId,
                  isTopLevel ? null : menuName,
                  area,
                );
              },
            },
            {
              ...
              value: function handleSidebarClick(event) {
                var clickedElement = event.target.closest(
                ...
                _wpDashboardTracking.default.trackNavClicked(
                  itemId,
                  null,
                  _wpDashboardTracking.NAV_AREAS.SIDEBAR_MENU,
                );
              },
            },
            {
            ...
            },
            {
              ...
              value: function determineNavArea(link) {
                ...
                if (parentMenu) {
                  var isSubmenuItem = link.closest(
                    ELEMENTOR_MENU_SELECTORS.SUBMENU_CONTAINER,
                  );
                  if (isSubmenuItem) {
                    var submenuElement = link.closest(
                      ELEMENTOR_MENU_SELECTORS.SUBMENU_ITEM_TOP_LEVEL,
                    );
                    if (
          ...
          return (0, _createClass2.default)(PluginActions, null, [
            ...
            },
            {
              ...
              value: function attachCoreDeactivationTracking() {
                var _this = this;
                var dialogForm = document.querySelector(
            ...
            },
            {
              ...
              value: function observeModalButtons() {
                var _this3 = this;
                var checkAndAttachDelegation =
                  function checkAndAttachDelegation() {
                    ...
                    _this3.addEventListenerTracked(
                      modal,
                      "click",
                      function (event) {
                        var submitButton =
                          event.target.closest(".dialog-submit");
            ...
            },
            {
              ...
              value: function getUserInput() {
                ...
                if (
                  !this.selectedReason ||
                  !reasonsWithInput.includes(this.selectedReason)
                ) {
                  return null;
                }
                var inputField = document.querySelector(
                  'input[name="reason_'.concat(this.selectedReason, '"]'),
                );
            ...
            },
            {
              ...
              value: function trackCoreDeactivation(action) {
                ...
                if (userInput) {
                  properties.deactivate_feedback_reason += "/".concat(
                    userInput,
                  );
                }
                _wpDashboardTracking.default.dispatchEvent(
              ...
              value: function attachProDeletionTracking() {
                ...
                jQuery(document).on(
                  ...
                  function (event, args) {
                    if (
                      "elementor-pro" ===
                      (args === null || args === void 0 ? void 0 : args.slug)
                    ) {
            ...
            },
            {
              ...
              value: function trackProAction(action) {
                ...
                var properties = (0, _defineProperty2.default)(
                  {},
                  config.propertyKey,
                  PLUGIN_TYPE.ELEMENTOR_PRO,
                );
                _wpDashboardTracking.default.dispatchEvent(
                  config.eventName,
                  properties,
          ...
          return (0, _createClass2.default)(PromotionTracking, null, [
                ...
                this.addEventListenerTracked(
                  ...
                  function (event) {
                    ...
                    var button = target.closest(
                      "a".concat(PROMO_SELECTORS.CTA_BUTTON),
                    );
                    if (!button) {
                      return;
                    }
                    var promoPage = button.closest(
                      ""
                        .concat(PROMO_SELECTORS.PROMO_PAGE, ", ")
                        .concat(PROMO_SELECTORS.PROMO_BLANK_STATE),
                    );
                    if (!promoPage) {
                      return;
                    }
            ...
            },
            {
              ...
              value: function extractPromoTitle(promoPage, button) {
                var titleElement = promoPage.querySelector(
                  PROMO_SELECTORS.TITLE,
                );
                return titleElement
          ...
          return (0, _createClass2.default)(ScreenViewTracking, null, [
            ...
            },
            {
              ...
              value: function getScreenData() {
                ...
                var hasNavTabs = document.querySelector(
                  SCREEN_SELECTORS.NAV_TAB_WRAPPER,
                );
                var hasSettingsTabs =
                  document.querySelectorAll(SCREEN_SELECTORS.SETTINGS_FORM_PAGE)
                    .length > 1;
                if (
                  hasNavTabs ||
                  hasSettingsTabs ||
                  (hash && !this.isElementorAppPage())
                ) {
                  ...
                  if (hash) {
                    ...
                    var activeTab = document.querySelector(
                      SCREEN_SELECTORS.NAV_TAB_ACTIVE,
                    );
                    if (activeTab) {
                      ...
                      if (tabText) {
                        screenId = ""
                          .concat(screenId, "-")
                          .concat(this.sanitizeScreenId(tabText));
                    ...
                    var activeSettingsTab = document.querySelector(
                      SCREEN_SELECTORS.SETTINGS_FORM_PAGE_ACTIVE,
                    );
              ...
              value: function attachNavTabTracking() {
                ...
                this.addEventListenerTracked(
                  ...
                  function (event) {
                    ...
                    if (
                      navTab &&
                      !navTab.classList.contains("nav-tab-active")
                    ) {
            ...
            },
            {
              ...
              value: function attachSettingsTabTracking() {
                var _this3 = this;
                var settingsPages = document.querySelectorAll(
                  SCREEN_SELECTORS.SETTINGS_FORM_PAGE,
                );
                        ...
                        if ("childList" === mutation.type) {
                          TRACKED_MODALS.forEach(function (modalSelector) {
                            ...
                            if (modal && _this4.isModalVisible(modal)) {
                              ...
                              _this4.trackScreen(
                                modalId,
                                _wpDashboardTracking.SCREEN_TYPES.POPUP,
                              );
                            }
                          });
                        }
            ...
            },
            {
              ...
              value: function isModalVisible(element) {
                ...
                return (
                  "none" !== style.display && 0 !== parseFloat(style.opacity)
                );
              },
            },
            {
              ...
              value: function trackScreen(screenId) {
                var screenType =
                  arguments.length > 1 && arguments[1] !== undefined
                    ? arguments[1]
                    : _wpDashboardTracking.SCREEN_TYPES.TOP_LEVEL_PAGE;
                ...
                _wpDashboardTracking.default.trackScreenViewed(
                  screenId,
                  screenType,
                );
              },
      ...
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var DashboardUtils = (exports.DashboardUtils = {
          isElementorPage: function isElementorPage() {
            ...
            if (
              page &&
              _wpDashboardTracking.default.elementorPages.some(function (p) {
            ...
            var postType = urlParams.get("post_type");
            if (
              _wpDashboardTracking.default.elementorPostTypes.includes(postType)
            ) {
              return true;
            }
            var body = document.body;
  ...
  \*************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var _navigation = _interopRequireDefault(
          __webpack_require__(
            /*! ./dashboard/navigation */ "../app/assets/js/event-track/dashboard/navigation.js",
          ),
        );
        var _pluginActions = _interopRequireDefault(
          __webpack_require__(
            /*! ./dashboard/plugin-actions */ "../app/assets/js/event-track/dashboard/plugin-actions.js",
          ),
        );
        var _promotion = _interopRequireDefault(
          __webpack_require__(
            /*! ./dashboard/promotion */ "../app/assets/js/event-track/dashboard/promotion.js",
          ),
        );
        var _screenView = _interopRequireDefault(
          __webpack_require__(
            /*! ./dashboard/screen-view */ "../app/assets/js/event-track/dashboard/screen-view.js",
          ),
        );
        var _menuPromotion = _interopRequireDefault(
          __webpack_require__(
            /*! ./dashboard/menu-promotion */ "../app/assets/js/event-track/dashboard/menu-promotion.js",
          ),
        );
        var _actionControls = _interopRequireDefault(
          __webpack_require__(
            /*! ./dashboard/action-controls */ "../app/assets/js/event-track/dashboard/action-controls.js",
          ),
        );
        ...
        var WpDashboardTracking = (exports["default"] =
          /*#__PURE__*/ (function () {
            ...
            return (0, _createClass2.default)(WpDashboardTracking, null, [
              ...
              },
              {
                ...
                value: function isEditorOneActive() {
                  ...
                  return (_elementorCommon$conf =
                    elementorCommon === null ||
                    elementorCommon === void 0 ||
                    (_elementorCommon$conf2 = elementorCommon.config) ===
                      null ||
                    _elementorCommon$conf2 === void 0 ||
                    (_elementorCommon$conf2 =
                      _elementorCommon$conf2.editor_events) === null ||
                    _elementorCommon$conf2 === void 0
                      ? void 0
                      : _elementorCommon$conf2.isEditorOneActive) !== null &&
                    _elementorCommon$conf !== void 0
              ...
              },
              {
                ...
                value: function processPendingNavClick() {
                  try {
                    var pendingNav = sessionStorage.getItem(
                      PENDING_NAV_CLICK_KEY,
                    );
                    if (pendingNav) {
              ...
              },
              {
                ...
                value: function isEventsManagerAvailable() {
                  var elementorCommon = this.getElementorCommon();
                  return (
                    (elementorCommon === null || elementorCommon === void 0
                      ? void 0
                      : elementorCommon.eventsManager) &&
                    "function" ===
                      typeof elementorCommon.eventsManager.dispatchEvent
                  );
                },
              },
              {
                ...
                value: function canSendEvents() {
                  ...
                  var elementorCommon = this.getElementorCommon();
                  return (_elementorCommon$conf3 =
                    elementorCommon === null ||
                    elementorCommon === void 0 ||
                    (_elementorCommon$conf4 = elementorCommon.config) ===
                      null ||
                    _elementorCommon$conf4 === void 0 ||
                    (_elementorCommon$conf4 =
                      _elementorCommon$conf4.editor_events) === null ||
                    _elementorCommon$conf4 === void 0
                      ? void 0
                      : _elementorCommon$conf4.can_send_events) !== null &&
                    _elementorCommon$conf3 !== void 0
                    ? _elementorCommon$conf3
                    : false;
                },
              },
              {
                ...
                value: function dispatchEvent(eventName) {
                  ...
                  elementorCommon === null ||
                    elementorCommon === void 0 ||
                    (_elementorCommon$even = elementorCommon.eventsManager) ===
                      null ||
                    _elementorCommon$even === void 0 ||
                    _elementorCommon$even.dispatchEvent(
                      eventName,
                      properties,
                      options,
                    );
                  ...
                  document.addEventListener("visibilitychange", function () {
                    if (!_this.sessionEnded && document.hidden) {
                      var timeSinceLastActivity =
                        Date.now() - _this.lastActivityTime;
              ...
              },
              {
                ...
                value: function isElementorPage(url) {
                  try {
                    ...
                    return !!(
                      (page &&
                        this.elementorPages.some(function (p) {
                          return page.includes(p);
                        })) ||
                      (postType &&
                        this.elementorPostTypes.includes(postType)) ||
                      (action &&
                        action.includes(this.anyPageWithElementorString))
                    );
                  } catch (error) {
                    return false;
                  }
                ...
                value: function attachNavigationListener() {
                  ...
                  var handleLinkClick = function handleLinkClick(event) {
                    ...
                    if (link && link.href) {
                      ...
                      if (
                        !_this2.sessionEnded &&
                        _this2.isNavigatingAwayFromElementor(link.href)
                      ) {
                    ...
                    var isSidebar = event.target.closest(
                  ...
                  var handleFormSubmit = function handleFormSubmit(event) {
                    ...
                    if (form.action) {
                      if (
                        !_this2.sessionEnded &&
                        _this2.isNavigatingAwayFromElementor(form.action)
                      ) {
                        _this2.trackSessionEnd("navigate_away");
              ...
              },
              {
                ...
                value: function trackActionControl(
                  controlIdentifier,
                  controlType,
                ) {
                  this.updateActivity();
              ...
              },
              {
                ...
                value: function trackPromoClicked(
                  promoName,
                  destination,
                  clickPath,
                ) {
              ...
              },
              {
                ...
                value: function trackSessionEnd() {
                  ...
                  var properties = {
                    wpdash_endstate_nav_summary: Array.from(
                      this.navItemsVisited,
                    ),
        ...
        (0, _defineProperty2.default)(
          WpDashboardTracking,
          "anyPageWithElementorString",
          "elementor",
        );
        (0, _defineProperty2.default)(WpDashboardTracking, "elementorPages", [
        ...
        module.exports = elementorModules.ViewModule.extend({
          getDefaultSettings: function getDefaultSettings() {
            return {
              selectors: {
                ...
                templateSelect:
                  ".elementor_maintenance_mode_template_id select",
          ...
          getDefaultElements: function getDefaultElements() {
            ...
            elements.$maintenanceModeDescriptions =
              elements.$maintenanceModeTable.find(
                selectors.maintenanceModeDescriptions,
              );
            elements.$maintenanceModeError =
              elements.$maintenanceModeTable.find(
          ...
          handleExcludeModeSelectChange:
            function handleExcludeModeSelectChange() {
          ...
          bindEvents: function bindEvents() {
            var elements = this.elements;
            elements.$modeSelect.on(
              "change",
              this.handleModeSelectChange.bind(this),
            );
  ...
  \**********************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var MenuHandler = (exports["default"] = /*#__PURE__*/ (function (
          _elementorModules$Vie,
        ) {
              ...
              value: function highlightTopLevelMenuItem($elementToHighlight) {
                var $elementToRemove =
                  arguments.length > 1 && arguments[1] !== undefined
                    ...
                    : null;
                var activeClasses =
                  "wp-has-current-submenu wp-menu-open current";
                $elementToHighlight
                  .parent()
  ...
  \****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var TemplateControls = (exports["default"] =
          /*#__PURE__*/ (function () {
              ...
              },
              {
                ...
                value: function setVisibilityForControl(
                  ...
                  var conditions = Object.entries(
                    (_controlSettings$cond = controlSettings.conditions) !==
                      null && _controlSettings$cond !== void 0
  ...
  \*************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var FilesUploadHandler = (exports["default"] =
          /*#__PURE__*/ (function () {
            ...
            return (0, _createClass2.default)(FilesUploadHandler, null, [
              ...
              },
              {
                ...
                value: function getUnfilteredFilesNotEnabledDialog(callback) {
                  var elementorInstance =
                    window.elementorAdmin || window.elementor;
  ...
  \*************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        exports.showJsonUploadWarningMessageIfNeeded =
        ...
        var genericMessageIntroductionKey =
          "upload_json_warning_generic_message";
        /**
        ...
        function createGenericWarningModal(IntroductionClass) {
          ...
          introduction
            .getDialog()
            .addElement("checkbox-dont-show-again", checkbox);
          (_introduction$getDial = introduction
            .getDialog()
            .getElements("message")) === null ||
  ...
  \*****************************************************/
      /***/ (__unused_webpack_module, exports) => {
        ...
        var matchUserAgent = function matchUserAgent(UserAgentStr) {
          ...
          isChrome =
            !!window.chrome && matchUserAgent("Chrome") && !(isEdge || isOpera),
          // Blink engine
  ...
  \*****************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var ExperimentsMessages = (exports["default"] =
          /*#__PURE__*/ (function () {
            ...
            return (0, _createClass2.default)(ExperimentsMessages, [
              ...
              },
              {
                ...
                value: function onExperimentStateChange(e) {
                  var experimentId = e.currentTarget.dataset.experimentId,
                    experimentNewState =
                      this.getExperimentActualState(experimentId);
              ...
              },
              {
                ...
                value: function isExperimentActive(experimentId) {
                  return (
                    this.getExperimentActualState(experimentId) === STATE_ACTIVE
                  );
                },
              },
              {
                ...
                value: function isExperimentActiveByDefault(experimentId) {
                  return (
                    this.getExperimentData(experimentId).default ===
                    STATE_ACTIVE
                  );
                },
              },
              ...
              },
              {
                ...
                value: function formatDependenciesList(dependencies) {
                  ...
                  return new Intl.ListFormat(languageCode).format(
                    dependenciesTitles,
                  );
                },
              },
              {
                ...
                value: function showDependenciesDialog(experimentId) {
                  ...
                  var message = __(
                    ...
                    .replace(
                      "%1$s",
                      "<strong>".concat(experimentName, "</strong>"),
                    )
  ...
  \*****************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var ExperimentsModule = (exports["default"] = /*#__PURE__*/ (function (
          _elementorModules$Vie,
        ) {
  ...
  \****************************************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var FloatingButtonsHandler = (exports["default"] =
          /*#__PURE__*/ (function (_AdminMenuHandler) {
            ...
            return (0, _createClass2.default)(FloatingButtonsHandler, [
                ...
                value: function getDefaultSettings() {
                  var pageName = "e-floating-buttons",
                    adminMenuSelectors = {
                      ...
                      contactPagesTablePage:
                        'a[href="edit.php?post_type=' + pageName + '"]',
                      contactPagesAddNewPage:
              ...
              },
              {
                ...
                value: function getDefaultElements() {
                  var selectors = this.getSettings("selectors"),
                    elements = _superPropGet(
                      FloatingButtonsHandler,
                      "getDefaultElements",
                      this,
                      3,
                    )([]);
                  elements.$templatesMenuItem = jQuery(
                    selectors.templatesMenuItem,
                  );
                  elements.$contactPagesMenuItem = jQuery(
                    selectors.contactPagesMenuItem,
                  );
                  return elements;
                },
              },
              {
                ...
                value: function onInit() {
                  ...
                  var settings = this.getSettings(),
                    isContactPagesTablePage = !!window.location.href.includes(
                      settings.paths.contactPagesTablePage,
                    ),
                    isContactPagesTrashPage = !!window.location.href.includes(
                      settings.paths.contactPagesTrashPage,
                    ),
                    isLContactPagesCreateYourFirstPage =
                  ...
                  if (
                    (_elementorAdminConfig = elementorAdminConfig.urls) !==
                      null &&
                    ...
                    this.elements.$templatesMenuItem
                      ...
                      .attr(
                        "href",
                        elementorAdminConfig.urls.viewContactPageUrl,
                      );
                  }
                  if (
                    isContactPagesTablePage ||
                    isContactPagesTrashPage ||
                    isLContactPagesCreateYourFirstPage
                  ) {
                    ...
                    this.highlightSubMenuItem(
                      this.elements.$contactPagesMenuItem,
                    );
          ...
          return (0, _createClass2.default)(_default, [
            {
              ...
              value: function runHandler() {
                var pageNameContact = "e-floating-buttons",
                  paths = {
                    contactPagesTablePage:
                      "edit.php?post_type=" + pageNameContact,
                    contactPagesAddNewPage:
                      "edit.php?post_type=elementor_library&page=" +
                      pageNameContact,
                    contactPagesTrashPage:
                      "edit.php?post_status=trash&post_type=" + pageNameContact,
                  },
                  args = {
                    paths: paths,
                  };
  ...
  \*****************************************************************/
      /***/ (__unused_webpack_module, exports, __webpack_require__) => {
        ...
        var LandingPagesHandler = (exports["default"] =
          /*#__PURE__*/ (function (_AdminMenuHandler) {
  ...
  \***************************************/
    ...
    __webpack_require__(
      /*! elementor-app/event-track/wp-dashboard-tracking */ "../app/assets/js/event-track/wp-dashboard-tracking.js",
    );
    (function ($) {
      var ElementorAdmin = elementorModules.ViewModule.extend({
        ...
        getDefaultElements: function getDefaultElements() {
          ...
          elements.$activeSettingsTab =
            elements.$settingsTabs.filter(".nav-tab-active");
          return elements;
        },
        ...
        bindEvents: function bindEvents() {
          ...
          Object.keys(campaignNotices).forEach(function (noticeId) {
            $(
              '.e-notice--cta.e-notice--dismissible[data-notice_id="'.concat(
                noticeId,
                '"] a.e-button--cta',
              ),
            ).on("click", function () {
          ...
          $(
            '.e-a-apps .e-a-item[data-plugin="image-optimization/image-optimization.php"] a.e-btn',
          ).on("click", function () {
            var $button = $(this);
            elementorCommon.ajax.addRequest(
        ...
        initTemplatesImport: function initTemplatesImport() {
          ...
          var canImport =
            ...
            ((_elementorAdminConfig =
              (_elementorAdminConfig2 =
                elementorAdminConfig.user.restrictions) === null ||
                          ...
                          switch ((_context.prev = _context.next)) {
                            case 0:
                              ...
                              _jsonUploadWarningMessage.showJsonUploadWarningMessageIfNeeded)(
                                {
                                  IntroductionClass:
                                    window.elementorModules.admin.utils
                                      .Introduction,
                                  introductionMap:
                                    window.elementorAdmin.config.user
                                      .introduction,
