  ...
  $(function handleGroupReady() {
    ...
    function group_ht_ctc() {
      ...
      $(document).on(
        "click",
        ".ht-ctc-sc-group",
        function handleGroupShortcodeClick() {
    ...
    function group_display(element) {
      ...
      if (is_mobile === "yes") {
        ...
        if ("show" === display_mobile) {
          ...
          var removeDesktopGroup = document.querySelector(
            ".ht_ctc_desktop_group",
          );
        ...
        if ("show" === display_desktop) {
          // remove mobile style
          var removeMobileGroup = document.querySelector(
            ".ht_ctc_mobile_group",
          );
