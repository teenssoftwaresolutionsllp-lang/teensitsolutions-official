...
(function htCtcShareModule($) {
  ...
  $(function handleShareReady() {
    ...
    try {
      ...
      console.warn(
        "navigator.userAgent unavailable while detecting share mode",
        error,
      );
    }
    ...
    function shareHtCtc() {
      ...
      $(document).on(
        "click",
        ".ht-ctc-sc-share",
        function handleShareShortcodeClick() {
    ...
    function shareDisplay(element) {
      ...
      if (isMobile === "yes") {
        ...
        if ("show" === display_mobile) {
          ...
          var removeDesktopShare = document.querySelector(
            ".ht_ctc_desktop_share",
          );
        ...
        if ("show" === display_desktop) {
          // remove mobile style
          var removeMobileShare = document.querySelector(
            ".ht_ctc_mobile_share",
          );
    ...
    function ht_ctc_share_things(element) {
      ...
      var an_time = $(element).hasClass("ht_ctc_entry_animation") ? 1200 : 120;
