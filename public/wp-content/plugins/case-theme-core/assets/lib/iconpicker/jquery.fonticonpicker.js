...
(function ($) {
  ...
  Plugin.prototype = {
              ...
              $(el)
                ...
                .each(
                  $.proxy(function (i, cel) {
                    ...
                    if (
                      newIconValue &&
                      newIconValue !== this.settings.emptyIconValue
                    ) {
                      ...
                      this.availableCategories[thisCategoryKey].push(
                        newIconValue,
                      );
          ...
          $.grep(
            ...
            $.proxy(function (n, i) {
              if (n.toLowerCase().search(searchString.toLowerCase()) >= 0) {
                this.iconsSearched[this.iconsSearched.length] =
    ...
    loadCategories: function () {
      ...
      this.selectCategory.show().val("all");
    },
    ...
    setSelectedIcon: function (theIcon) {
      if (theIcon === "fip-icon-block" || typeof theIcon === typeof undefined) {
        theIcon = "";
      }
          ...
          this.iconPicker
            ...
            .html(
              "<i " +
                ...
                '="' +
                (this.settings.convertToHex
                  ? "&#x" + parseInt(theIcon, 10).toString(16) + ";"
                  : theIcon) +
                '"></i>',
            );
        } else {
      ...
      if (
        ...
        typeof this.element.val() != typeof undefined
      ) {
        this.element
          .val(theIcon === "" ? this.settings.emptyIconValue : theIcon)
          .trigger("change");
      }
