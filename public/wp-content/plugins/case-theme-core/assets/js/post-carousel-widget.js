(function ($) {
  ...
  var WidgetPostCarouselHandler = function ($scope, $) {
    ...
    owlCarousel.each(function () {
      ...
      var data = {
        navText: [
          '<i class="zmdi zmdi-chevron-left"></i></i>',
      ...
      if (typeof _this.attr("data-dotscontainer") !== "undefined") {
        data.dotsContainer =
          _this.attr("data-dotscontainer") == "true"
            ? _this.parent().find(".slider-nav .thumbs")
            : "";
      }
      ...
      _this
        .parent()
        .find(".ct-carousel-filter")
        .on("click", ".ct-filter-item", function (e) {
          var filter_data = $(this).attr("data-filter");
          if ($(this).hasClass("ct-filter-active")) return;
          $(this)
            .addClass("ct-filter-active")
            .siblings()
            .removeClass("ct-filter-active");
  ...
  $(window).on("elementor/frontend/init", function () {
    elementorFrontend.hooks.addAction(
      "frontend/element_ready/post_carousel.default",
