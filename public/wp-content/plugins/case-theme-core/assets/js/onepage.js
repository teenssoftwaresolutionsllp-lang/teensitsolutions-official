(function ($) {
  ...
  if (typeof one_page_options != "undefined") {
    ...
    $.each(
      $(
        ".ct-header-elementor-sticky .is-one-page, .ct-header-main:not(.ct-header-mobile-main) .is-one-page",
      ),
      function (index, item) {
        ...
        var waypoint = new Waypoint({
          ...
          handler: function (direction) {
            if (direction === "down") {
              ...
              if (prev.length > 0) prev.addClass("ct-onepage-active");
            }
          },
          offset: _data_offset,
        });
