  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      jQuery(document).ready(function ($) {
        ...
        $("#ai1wm-feedback-type-3").click(function () {
          // Hide other options
          $("#ai1wm-feedback-type-1, #ai1wm-feedback-type-2")
            .closest("li")
            .hide();
          ...
          $(".ai1wm-feedback-form")
            ...
            .attr("placeholder", ai1wm_locale.how_may_we_help_you);
          ...
          $.ajax({
            ...
            if (data.errors.length > 0) {
              ...
              successMessage.append(
                $("<p />").text(
                  ai1wm_locale.thanks_for_submitting_your_feedback,
                ),
              );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      jQuery(document).ready(function ($) {
        ...
        $("#ai1wm-report-problem-button").click(function (e) {
          $(this)
            .next(".ai1wm-report-problem-dialog")
            .toggleClass("ai1wm-report-active");
        ...
        $("#ai1wm-report-cancel").click(function (e) {
          $(this)
            .closest(".ai1wm-report-problem-dialog")
            .removeClass("ai1wm-report-active");
        ...
        $("#ai1wm-report-submit").click(function (r) {
          ...
          $.ajax({
            ...
            if (data.errors.length > 0) {
              ...
              successMessage.append(
                $("<p />").text(
                  ai1wm_locale.thanks_for_submitting_your_request,
                ),
              );
              ...
              // Hide message
              setTimeout(function () {
                $(".ai1wm-report-problem-dialog").removeClass(
                  "ai1wm-report-active",
                );
              }, 2000);
            }
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      Import.prototype.confirm = function (options, retries) {
        ...
        var params = this.params
          .concat({ name: "secret_key", value: ai1wm_import.secret_key })
          .concat({ name: "priority", value: 150 });
      ...
      Import.prototype.clean = function (options, retries) {
        ...
        var params = this.params
          .concat({ name: "secret_key", value: ai1wm_import.secret_key })
          .concat({ name: "priority", value: 400 });
      ...
      var Modal = function Modal() {
        ...
        this.info = function (params) {
          ...
          var warning = $("<p></p>").html(
            ai1wm_locale.please_do_not_close_this_browser,
          );
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function (global) {
        ...
        jQuery(document).ready(function ($) {
          ...
          $(".ai1wm-expandable > div.ai1wm-button-main").on(
            "click",
            function () {
        ...
        global.Ai1wm = jQuery.extend({}, global.Ai1wm, {
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      /* WEBPACK VAR INJECTION */ (function (fetch) {
        ...
        FileUploader.prototype.upload = function (file, retries) {
          ...
          var chunkSize =
            file.size > ai1wm_uploader.chunk_size
              ? ai1wm_uploader.chunk_size
              : file.size;
            ...
            .catch(function (error) {
              ...
              if (retries >= 30) {
                return _this2.onError(
                  new Error(ai1wm_locale.problem_while_uploading_your_file),
                );
              }
        ...
        FileUploader.prototype.getFormData = function (file, chunkSize) {
          ...
          formData.append(
            "upload-file",
            file.slice(0, chunkSize, "application/octet-binary"),
          );
    ...
    /***/ function (module, exports, __webpack_require__) {
      /* WEBPACK VAR INJECTION */ (function (global, Promise) {
        ...
        /* WEBPACK VAR INJECTION */
      }).call(exports, __webpack_require__(0), __webpack_require__(49));
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var ITERATOR = __webpack_require__(1)("iterator");
      var Iterators = __webpack_require__(12);
      module.exports = __webpack_require__(11).getIteratorMethod = function (
        it,
      ) {
        if (it != undefined)
